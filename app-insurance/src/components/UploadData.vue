  ...
  export default {
    ...
    methods: {
      toggleAddPic: function () {
        let vm = this;
        if (Object.keys(vm.imgUrls).length >= 1) {
          if (vm.imgUrls.image1 !== '') {
            vm.isPhoto1 = false;
          }
          if (vm.imgUrls.image2 !== '') {
            vm.isPhoto2 = false;
          }
          if (vm.imgUrls.image3 !== '') {
            vm.isPhoto3 = false;
          }
          if (vm.imgUrls.image4 !== '') {
            vm.isPhoto4 = false;
          }
          if (vm.imgUrls.image5 !== '') {
            vm.isPhoto5 = false;
          }
          if (vm.imgUrls.image6 !== '') {
            vm.isPhoto6 = false;
          }
        } else {
          // vm.isPhoto = true;
        }
        console.log(vm.isPhoto2)
      },
      //添加图片
      addPic1: function () {
