...
public class JacksonUtil {
	...
	public String setCustomFilter(String filterName,Object objData,String...fileds){

		// first, construct filter provider to exclude all attribute but 'name', bind it as 'myFilter'
		com.fasterxml.jackson.databind.ser.FilterProvider filters = new com.fasterxml.jackson.databind.ser.impl.SimpleFilterProvider().addFilter(filterName,
		    com.fasterxml.jackson.databind.ser.impl.SimpleBeanPropertyFilter.filterOutAllExcept(fileds));
		// and then serialize using that filter provider:
		try {
			mapper.setFilters(filters);
			String json = mapper.writeValueAsString(objData);
			return json;
		} catch (IOException e) {
