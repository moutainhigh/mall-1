...
<div id="main" class="clearfix">
    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <!-- End .actionbar-->
            <div class="inner-padding">
                <form:form id="validateSubmitForm" cssClass="form-horizontal" action="addLogisticPrice.do" method="post" commandName="logisticPrice">
                                    ...
                                    <c:forEach var="province" items="${provinces}">
                                        <li>
                                            <p><i class="fa  fa-plus-square" style="cursor: pointer" onclick="expandProvince(this)"></i>
                                                <input type="checkbox" value="${province.code}" onchange="changeProvinceCheck(this)"> ${province.name}</p>
                                            <div style="display: none">
                                                <c:forEach var="city" items="${province.cities}">
                                                    <input type="checkbox" name="cityCode" value="${city.code}"> ${city.name}&nbsp;&nbsp;
                                                </c:forEach>
                                            </div>
                                        </li>
                                    </c:forEach>
