            ...
            <div class="inner-padding">
                ...
                <div class="toolbar responsive-helper">
                    <header>
                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                <a href="addPage.do" class="btn btn-default"><i class="fa fa-plus-circle"></i>&nbsp;新增</a>
                ...
                <div class="table-wrapper">
                    <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="450" resizable="true">
                        ...
                        <kendo:grid-columns>
                            <kendo:grid-column title="编号"  field="brandNo" width="100px"/>
                            <kendo:grid-column title="图片"  field="brandName" width="100px"/>
                            <kendo:grid-column title="品牌名称"  field="brandName" width="100px"/>
                            <kendo:grid-column title="国别"  field="catalogId" width="100px"/>
                            <kendo:grid-column title="是否显示"  field="isDisplay" width="100px"/>
                            <kendo:grid-column title="是否热门"  field="isHot" width="100px"/>
                            <kendo:grid-column title="介绍"  field="remark" width="100px"/>
                            <kendo:grid-column title="创建时间"  field="createTime" width="100px"/>
                        </kendo:grid-columns>
                        <kendo:dataSource serverPaging="true" serverFiltering="true" serverSorting="true">
                            <kendo:dataSource-schema data="data" total="rowCount">
