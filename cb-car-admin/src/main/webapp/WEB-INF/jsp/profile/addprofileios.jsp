    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <div class="inner-padding">
                ...
                <fieldset>
                    <legend>事项组</legend>
                    <form:form id="validateSubmitForm" action="addProfileIos.do"
                    ...
                    <div class="row">
                            ...
                            function upload(){
                                ...
                                $.ajax({
                                    ...
                                    success: function (result) {
                                        $('#IOS_URL').val(result.url);
                                        $('#IOS_VERSION_CODE').val(result.versionCode);
                                        $('#IOS_VERSION_NAME').val(result.versionName);
                        ...
                        <div class="col-sm-2">
                            <label><span class="asterisk">*</span>ios文件导入：</label>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <label><span class="asterisk">*</span>苹果版本编号：</label>
                        </div>
                        <div class="col-sm-3">
                            <input   name="IOS_VERSION_CODE" id="IOS_VERSION_CODE" value=""
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <label><span class="asterisk">*</span>苹果版本名称：</label>
                        </div>
                        <div class="col-sm-3">
                            <input  name="IOS_VERSION_NAME" id="IOS_VERSION_NAME" value=""
                                   cssClass="form-control validate[required,minSize[1]]"
                                   style="width: 600px;padding: 5px;"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <label><span class="asterisk">*</span>苹果名称：</label>
                        </div>
                        <div class="col-sm-3">
                            <input name="IOS_APP_NAME" value=""
                                   cssClass="form-control validate[required,minSize[1]]"
                                   style="width: 600px;padding: 5px;"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <label><span class="asterisk">*</span>苹果URL：</label>
                        </div>
                        <div class="col-sm-3">
                            <input readonly="readonly" name="IOS_URL" id="IOS_URL" value=""
                                   cssClass="form-control validate[required,minSize[1]]"
                                   style="width: 600px;padding: 5px;"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <label><span class="asterisk">*</span>苹果描述：</label>
                        </div>
                        <div class="col-sm-3">
                                <textarea rows="3" cols="100" name="IOS_DESCRIPTION"
