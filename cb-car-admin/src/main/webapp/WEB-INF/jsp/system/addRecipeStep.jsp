  ...
  <div id="main" class="clearfix">
      ...
      <div class="header-main-bottom">
        <div class="pull-left">
          <ul class="breadcrumb">
            ...
            <li class="active"><a href="#">新增菜谱步骤</a></li>
          </ul>
          <!-- End .breadcrumb -->
        </div>
        <div class="pull-right">
    ...
    <div id="content" class="clearfix">
      ...
      <div class="window">
        ...
        <!-- End .actionbar-->
        <div class="inner-padding">
          <form:form id="validateSubmitForm" cssClass="form-horizontal" action="addRecipeStep.do" method="post" commandName="recipeStep" >

            <fieldset>
              <legend>新增菜谱步骤</legend>
