...
<head>
  ...
  <script type="text/javascript">
    function editItem() {
      ...
      if (dataItem) {
        window.location.href = "toEditKeyWord.do?keyWordId=" + dataItem.keyWordId;
      }
    }
    ...
    function removeItem() {
      ...
      if (dataItem) {
        bootbox.confirm("确认删除吗？", function (result) {
          if (result) {
            $.get("removeKeyWordById.do", {
              keyWordId: dataItem.keyWordId
            }, function (data) {
              if (data) {
                bootbox.alert("成功");
      ...
      <div class="header-main-bottom">
        <div class="pull-left">
          <ul class="breadcrumb">
            <li><a href="#">首页</a></li>
            <li><a href="#">参数管理</a></li>
            <li class="active"><a href="#">敏感词管理</a></li>
          </ul>
          <!-- End .breadcrumb -->
        </div>
        <div class="pull-right">
        ...
        <div class="inner-padding">
          <div class="toolbar responsive-helper">
            <form>
              <div class="pull-left">
                ...
                <div class="toolbar-field">
                  <input type="text" data-filter="keyValue" data-operator="contains" class="form-control grid-filter" placeholder="请输入敏感词"/>
                </div>
              </div>
              <!-- End .pull-left -->
              <div class="pull-right">
          ...
          <div class="toolbar responsive-helper">
            <header>
              ...
              <div class="pull-right">
                <div class="btn-group">
                  <a href="toAddKeyWord.do" class="btn btn-default"><i class="fa fa-plus-circle"></i>&nbsp;新增</a>
          ...
          <div class="table-wrapper">
            <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="450" resizable="true">
              ...
              <kendo:grid-columns>
                <kendo:grid-column title="敏感词key" field="keyKey"/>
                <kendo:grid-column title="敏感词" field="keyValue"/>
              </kendo:grid-columns>
              <kendo:dataSource serverPaging="true" serverFiltering="true" serverSorting="true">
                <kendo:dataSource-schema data="content" total="totalElements">
                </kendo:dataSource-schema>
                <kendo:dataSource-transport>
                  <kendo:dataSource-transport-read url="pageKeyWords.do" type="POST" contentType="application/json"/>
