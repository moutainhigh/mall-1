  ...
  <div id="main" class="clearfix">
    ...
    <div id="content" class="clearfix">
      ...
      <div class="window">
        ...
        <!-- End .actionbar-->
        <div class="inner-padding">
          <form:form id="validateSubmitForm" cssClass="form-horizontal" action="editRuleCondition.do" method="post" commandName="ruleCondition" >
            ...
            <fieldset>
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <form:input path="ruleCode" type="text" cssClass="form-control validate[required,custom[onlyLetterNumber]]" maxlength="32" readonly="true"/>
                </div>
                <div class="col-sm-2">
