                                ...
                                <table id="filterTable" class="table table-bordered table-striped">
                                    ...
                                    <c:forEach var="item" items="${filter.filterItems}">
                                        <tr id='filterItem${item.itemId}'>
                                            <td><input type='text' name='itemName' value="${item.itemName}" required="true" class='form-control' readonly="readonly"/></td>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="btn-group pull-right">
                                    <a class="btn btn-default pull-right" href="propertyFilters.do">返回</a>
                                </div>
                            </div>
                        </div>
                    </fieldset>
