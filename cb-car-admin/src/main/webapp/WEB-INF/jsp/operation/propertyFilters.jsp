...
<head>
    ...
    <script type="text/javascript">
        ...
        function detailItem(){
            ...
            if (dataItem) {
                window.location.href = "propertyFilterDetail.do?filterId=" + dataItem.filterId;
            }
        }
        ...
        function editItem() {
            var dataItem = getSelectedGridItem("grid");
            if (dataItem) {
                window.location.href = "toEditPropertyFilter.do?filterId=" + dataItem.filterId;
            }
        }
        ...
        function removeItem() {
            ...
            if (dataItem) {
                bootbox.confirm("确认删除吗？", function (result) {
                    if (result) {
                        $.get("removePropertyFilterById.do", {
                                    ...
                                    <li class="eft-closed"><i class="fa fa-folder"></i>${category2.text}
                                            <ul>
                                                <c:forEach var="category3" items="${category2.items}">
                                                    <li><i class="fa fa-file-text"></i><a href="#">${category3.text}</a></li>
                                                </c:forEach>
                                            </ul>
                                        </li>
                                </c:forEach>
            ...
            <div class="inner-padding">
                    ...
                    <header>
                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                ...
                                <a href="toAddPropertyFilter.do" class="btn btn-default"><i class="fa fa-plus-circle"></i>&nbsp;新增</a>
                ...
                <div class="table-wrapper">
                    <kendo:grid name="grid" pageable="false" sortable="true" selectable="true" height="450">
                        ...
                        <kendo:grid-columns>
                            <kendo:grid-column title="过滤器名称" field="filterName" width="350px"/>
                            <kendo:grid-column title="所属运营分类" field="category.categoryName" width="350px"/>
                        ...
                        <kendo:dataSource serverPaging="true" serverFiltering="true" serverSorting="true">
                            ...
                            <kendo:dataSource-transport>
                                <kendo:dataSource-transport-read url="pagePropertyFilters.do" type="POST" contentType="application/json"/>
