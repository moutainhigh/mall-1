    ...
    <div class="window">
      ...
      <div class="inner-padding">
        <form:form id="validateSubmitForm" cssClass="form-horizontal"  action="editSystemLetter.do" method="post"  commandName="systemLetter">
          <form:input path="letterId" cssStyle="display: none"/>
          <fieldset>
            <legend>站内信详情</legend>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <form:select id="publishTypeSelect" path="publishType" cssClass="form-control simpleselect" disabled="true">
                  <form:options items="${publishType}" itemLabel="typeName" disabled=""></form:options>
                </form:select>
              </div>
            </div>
            ...
            <div id="recipientDiv" class="row">
              ...
              <div  class="col-sm-4">
                <form:input cssClass="form-control" path="recipient" id="recipientInput" disabled="true"/>
              </div>
              <div  class="col-sm-2">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <form:input cssClass="form-control validate[required]"  path="title" maxlength="128" disabled="true"/>
              </div>
            </div>
            <div class="spacer-30"></div>
            <div class="row">
              ...
              <div class="col-sm-6" >
                <form:textarea cssClass="form-control validate[required,maxSize[3000]]" path="content" disabled="true"/>
              </div>
            </div>
          </fieldset>
        </form:form>
        <div class="spacer-40"></div>
        <div class="hr-totop"><span>Top</span></div>N
        <div class="spacer-40"></div>
