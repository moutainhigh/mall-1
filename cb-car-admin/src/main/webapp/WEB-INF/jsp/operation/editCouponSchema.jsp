...
<div id="main" class="clearfix">
        ...
        <div class="header-main-bottom">
            <div class="pull-left">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="#">修改优惠券方案</a></li>
                </ul>
                <!-- End .breadcrumb -->
            </div>
            <div class="pull-right">
    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <!-- End .actionbar-->
            <div class="inner-padding">
                <form:form id="validateSubmitForm" data-asf-expireafter="1" data-asf-time="10" action="editCouponSchema.do" method="post" commandName="couponSchema">

                    <form:hidden path="schemaId"/>
                    <!-- * data-asf-time = seconds, data-asf-expireafter = minutes * -->
                    <fieldset>
                        <legend>修改优惠券方案</legend>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <kendo:dateTimePicker id="startTime" name="startTime" value="${couponSchema.startTime}" format="yyyy-MM-dd HH:mm:ss" parseFormats="['yyyy-MM-dd','HH:mm:ss']"
                                                      culture="zh-CN"></kendo:dateTimePicker>
                            </div>
                            <div class="col-sm-1"></div>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-3">
                                <kendo:dateTimePicker id="endTime" name="endTime" value="${couponSchema.endTime}" format="yyyy-MM-dd HH:mm:ss" parseFormats="['yyyy-MM-dd','HH:mm:ss']"
                                                      culture="zh-CN"></kendo:dateTimePicker>
                            </div>
                            <div class="col-sm-1"></div>
                        </div>
