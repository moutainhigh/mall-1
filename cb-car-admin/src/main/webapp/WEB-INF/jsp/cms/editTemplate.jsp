...
<div id="main" class="clearfix">
    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <div class="inner-padding">
                <form:form id="validateSubmitForm" action="editTemplate.do" cssClass="form-horizontal" method="post" commandName="template">
                    <fieldset>
                        <legend>模板表单</legend>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <form:input cssClass="form-control validate[required,minSize[2]]" path="templateName" maxlength="255" readonly="true"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-3">
                                <form:input cssClass="form-control validate[required,minSize[2]]" path="templatePath" readonly="true"/>
                            </div>
                        </div>
                        <div class="spacer-10"></div>
                        <div class="row">
