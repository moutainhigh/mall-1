    ...
    <script type="application/javascript">
        $(document).ready(function () {
            $("#publishDate").kendoDatePicker({
                format: "yyyy-MM-dd",
                value:kendo.toString(new Date('${article.publishDate}'), "yyyy-MM-dd"),
                min: new Date(),
                culture:"zh-CN",
            ...
            $("#orderTime").kendoDateTimePicker({
                ...
                value:kendo.toString(new Date('${article.orderTime}'), "yyyy-MM-dd HH:mm:ss"),
                min: kendo.toString(new Date(), "yyyy-MM-dd HH:mm:ss"),
                culture:"zh-CN",
...
<div id="main" class="clearfix">
    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <div class="inner-padding">
                <form:form id="validateSubmitForm" action="editArticle.do" cssClass="form-horizontal" method="post" commandName="article">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <kendo:colorPicker id="titleColor" name="titleColor" buttons="false" value="${article.titleColor}"></kendo:colorPicker>
                            </div>
                        </div>
                                ...
                                <table id="imageStepTable" class="table table-bordered table-striped">
                                    ...
                                    <c:forEach var="rStep" items="${recipeSteps}" varStatus="cou">
                                        <tr id="imageTr${rStep.stepId}">
                                            ...
                                            <td>
                                                <input type='text' name='stepDescription' class='form-control validate[required]' value="${rStep.description}" maxLength='255'/>
                                            </td>
                                            <td>
                                                <input type='text' name='stepRemark' class='form-control' value="${rStep.remark}"  maxLength='255'/>
                                            </td>
                                            <td>
                                                <input type='text' name='stepWhen' style='width:40px;' value="${rStep.stepWhen}" class='form-control validate[required,custom[number]]' maxLength='4'/>
                                            </td>
                                            <td>
                                                <input type='text' name='stepOrder' value='${rStep.stepOrder}' style='width:40px;' class='form-control validate[required,custom[number]]' maxLength='4'/>
                                            </td>
                                            <td>
                                                <a type='button' title='删除' class='btn btn-default' href='javascript:removeImage(${rStep.stepId})'><i class='fa fa-minus-circle'></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
