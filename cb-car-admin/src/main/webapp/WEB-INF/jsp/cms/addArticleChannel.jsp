...
<div id="main" class="clearfix">
    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <div class="inner-padding">
                <form:form id="validateSubmitForm" action="addArticleChannel.do" cssClass="form-horizontal" method="post" commandName="channel">
                    <fieldset>
                        <legend>频道表单</legend>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <form:select path="channelPosition" cssClass="form-control simpleselect">
                                    ...
                                    <form:option value="BANNER" selected="selected">横幅</form:option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="checkbox" name="channelTypes" value="WEB_SITE" cssClass="form-control validate[minCheckbox[1]]"/>网站
                                <input type="checkbox" name="channelTypes" value="PAD" cssClass="form-control validate[minCheckbox[1]]"/>平板
                                <input type="checkbox" name="channelTypes" value="MOBILE" cssClass="form-control validate[minCheckbox[1]]"/>手机
                            </div>
                        </div>
