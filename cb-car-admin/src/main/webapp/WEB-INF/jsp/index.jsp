...
<div id="container-loginmin" class="clearfix">
  ...
  <div style="position: relative">
    ...
    <form id="form-login" style="width: 100%;margin-top: 50px;position: absolute;" action="doLogin.do" method="post">
      ...
      <div class="login-fields-wrapper" style="float: none; width: 100%">
        ...
        <div class="spacer-20"><div  style="width: 100%;position:relative;  font-size: 14px;color: red;margin-left: 30px"> ${errorMessage}</div></div>
        <div class="row">
