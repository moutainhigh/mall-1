...
INSERT INTO `insurance_informed_matter` VALUES (1, 'C1.您是否正在申请或已经拥有任何保险公司的保险合同？若是，请说明：承包公司、保险品种、保险金额总和、因被保险人死亡给付的保险金总和。住院每日补贴日额及保险合同生效日期。', '2018-07-06 17:32:19', 1, 1, NULL, 0);
INSERT INTO `insurance_informed_matter` VALUES (2, 'C2.您的人寿保险、人身意外或健康保险的投保申请是否曾被拒保、推迟、加费、或作限制保障权益？是否有解除保险合同？是否曾向任何保险公司提出索赔申请？若“是”，请说明。', '2018-07-06 17:32:57', 2, 1, NULL, 0);
INSERT INTO `insurance_informed_matter` VALUES (3, 'C3.是否计划出国或改变居住地或工作地点？正在试图参加私人性质飞行，或携带氧气瓶潜水、或登山、或从事危险性的运动？若“是”，请填妥相关问卷，连同此投保单一并交回本公司。', '2018-07-06 17:33:12', 3, 1, NULL, 0);
INSERT INTO `insurance_informed_matter` VALUES (4, 'C4.是否持有有效摩托车驾照？', '2018-07-06 17:33:28', 4, 1, NULL, 0);
INSERT INTO `insurance_informed_matter` VALUES (5, 'C5.a.是否吸烟?若“是”，吸烟{0}年{1}支/天；若现在已停止吸烟，停止吸烟原因及时间{2}。b.是否饮酒？若“是”，饮酒{3}年，种类{4}，数量{5}（两/周）；若现在已停止饮酒，停止饮酒原因及时间{6}。', '2018-07-06 17:33:44', 5, 1, NULL, 1);
INSERT INTO `insurance_informed_matter` VALUES (6, 'C6.您是否曾经或正在使用麻醉剂、可成瘾药物、毒品或接受戒毒、戒酒治疗？', '2018-07-06 17:34:04', 6, 1, NULL, 0);
...
INSERT INTO `insurance_informed_matter` VALUES (11, 'C11.您若为16周岁(含)以上女性，请告知：a.目前是否怀孕？若是，怀孕{0}周？b.（曾）患子宫、卵巢、乳房或其他生殖器官疾病？c.（曾）异常妊娠、阴道异常出血或接受下腹部手术？d.母亲、姐妹中是否有人（曾）患乳腺、子宫、卵巢等生殖器官恶性肿瘤？', '2018-07-06 17:36:46', 11, 1, NULL, 1);
...
INSERT INTO `customer` VALUES (1, '888888', '1', '2016-03-22 21:58:37', '1', '1', '2016-03-22 21:58:43', 1, '1', '1', b'1', 1, 0, b'1', '888888', b'1', '888888', '1', '1', '1', '1', '1', '1', '888888', '1', b'1', '1', 0, 1, b'0', NULL, NULL, NULL, NULL, 0, 0);
