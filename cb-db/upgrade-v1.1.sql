...
ALTER TABLE category ADD COLUMN `LOWEST_PRICE` decimal(5, 2) NOT NULL COMMENT '最低价格';
ALTER TABLE category ADD COLUMN `HIGHEST_PRICE` decimal(5, 2) NOT NULL COMMENT '最高价格';
