/*
 ...
 Source Server         : 119.23.59.102_3306
 Source Server Type    : MySQL
 Source Server Version : 50556
 Source Host           : 119.23.59.102:3306
 Source Schema         : skc
...
CREATE TABLE `activity`  (
  ...
  `ACTIVITY_ALIAS` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ACTIVITY_CATEGORY_IDS` tinyblob,
  ...
  `LIMIT_AMOUNT_SIZE` int(11) DEFAULT NULL,
...
CREATE TABLE `advertisement`  (
  ...
  `ADVERT_URL` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `VIDEO_PATH` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `article_channel`  (
  ...
  `ENABLED` bit(1) NOT NULL,
  `OPERA_IMG_PATH` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SEO_DESCRIPTION` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `TIP_NAME` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CHANNEL_POSITION` int(11) NOT NULL,
  `CHANNEL_URL` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CHANNEL_VIDEO_URL` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `brand`  (
  ...
  `BRAND_EN_NAME` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SEO_DESCRIPTION` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SEO_KEY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `commodity`  (
  ...
  `AUDIT_REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `BARTER` bit(1) DEFAULT NULL,
  ...
  `COMMODITY_PYNAME` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `COMMODITY_STATE` int(11) NOT NULL,
  `COMMODITY_TITLE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `CONTENT` varchar(4098) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `COST_PRICE` double NOT NULL,
  `CREATE_TIME` datetime DEFAULT NULL,
  `DEFAULT_PIC_PATH` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DELIVERY_TYPE` int(11) DEFAULT NULL,
  `DESCRIPTION` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `FORBID_AIR_CARGO` bit(1) DEFAULT NULL,
  `GIVEAWAY` bit(1) DEFAULT NULL,
  `MARKET_PRICE` double DEFAULT NULL,
  `POPULAR` bit(1) DEFAULT NULL,
  `PRE_SELL` bit(1) DEFAULT NULL,
  `PROVINCE` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `PACKING_LIST` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `customer`  (
  ...
  `CARD_NO` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `ENABLED` bit(1) NOT NULL,
  `EXCHANGE_INTEGRAL` int(11) DEFAULT NULL,
  `INTEGRAL` int(11) DEFAULT NULL,
  `MAIL_CHECKED` bit(1) DEFAULT NULL,
  `MOBILE` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `MOBILE_CHECKED` bit(1) DEFAULT NULL,
  ...
  `QQ_ACCESS_TOKEN` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `QQ_FIGURE_URL` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `QQ_NICK_NAME` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `QQ_OPEN_ID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `REAL_NAME` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `REMARK` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SEX` bit(1) DEFAULT NULL,
  `TELEPHONE` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TOTAL_INTEGRAL` int(11) DEFAULT NULL,
  `RANK` int(11) DEFAULT NULL,
  `EMAIL_CHECKED` bit(1) DEFAULT b'0',
  `RONG_CLOUD_TOKEN` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '融云TOKEN',
  `AVATAR_URL` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '头像',
  `RECOMMEND_CUSTOMER_ID` int(11) DEFAULT NULL COMMENT '推荐人',
  `NICK_NAME` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 179 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Compact;
...
CREATE TABLE `customer_friend`  (
  ...
  `CREATE_TIME` datetime DEFAULT NULL,
  `ALIAS_NAME` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '别名',
  `TAG` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '标签',
  `PHONE` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '电话',
  `DESCRIPTION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '描述',
  `IMAGE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '相关图片',
  `STATE` int(2) UNSIGNED ZEROFILL DEFAULT 00 COMMENT '好友状态：0正常，1黑名单',
...
CREATE TABLE `customer_friend_request`  (
  ...
  `CREATE_TIME` datetime DEFAULT NULL,
  `REQUEST_MESSAGE` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `STATE` int(2) DEFAULT NULL COMMENT '0,新请求；1,同意，2，拒绝，3，忽略',
...
CREATE TABLE `delivery_address`  (
  ...
  `CONSIGNEE_MOBILE` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CONSIGNEE_NAME` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `CONSIGNEE_TELEPHONE` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `device`  (
  ...
  `CREATE_TIME` datetime DEFAULT NULL,
  `DEVICE_CODE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `evaluate`  (
  ...
  `COMMODITY_NAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `feedback`  (
  ...
  `customer_id` int(11) DEFAULT NULL,
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `images` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
...
CREATE TABLE `goods_change`  (
  ...
  `PIC_PATH` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PROVINCE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `insurance_informed_matter`  (
  ...
  `SER_NO` int(11) DEFAULT NULL COMMENT '序号',
  `ENABLED` int(255) DEFAULT NULL COMMENT '是否启用',
  `GROUP_ID` int(11) DEFAULT NULL COMMENT '所属组',
  `MATTER_TYPE` int(11) DEFAULT 0 COMMENT '0：是否题；1：填空题',
...
CREATE TABLE `insurance_order`  (
  ...
  `CONTRACT_NO` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '合同编号',
  `PROD_ID` int(11) NOT NULL COMMENT '产品ID',
  `PRICE_ID` int(11) DEFAULT NULL COMMENT '保额',
  ...
  `OFFSITE_ID` int(11) DEFAULT NULL COMMENT '异地投保信息',
  `BAR_CODE` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '条形码',
...
CREATE TABLE `insurance_order_beneficiary`  (
  ...
  `BENEFICIARY_CAREER` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受益人职业',
  ...
  `BENEFICIARY_HEIGHT` int(11) DEFAULT NULL COMMENT '受益人身高',
  `BENEFICIARY_BODY_WEIGHT` float DEFAULT NULL COMMENT '受益人体重',
  `BENEFICIARY_INCOME` int(255) NOT NULL COMMENT '受益人收入',
  `BENEFICIARY_MARRIAGE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受益人婚否',
  `BENEFICIARY_TEL` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受益人固定电话',
  `BENEFICIARY_MOBILE` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受益人手机号',
  `BENEFICIARY_EMAIL` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受益人邮箱',
  `BENEFICIARY_PROVINCE` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受益人所在省',
  `BENEFICIARY_CITY` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受益人所在市',
  `BENEFICIARY_DISTRICT` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受益人所在区',
  `BENEFICIARY_ADDRESS` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受益人详细地址',
  `INSURED_RELATION` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '与被保人关系',
  `BENEFICIARY_ORDER` int(11) DEFAULT 1 COMMENT '收益顺序',
  `BENEFICIARY_PROPORTION` int(11) DEFAULT 0 COMMENT '收益份额',
...
CREATE TABLE `insurance_order_informed_matter`  (
  ...
  `RESULT` int(255) UNSIGNED ZEROFILL DEFAULT NULL COMMENT '采集结果',
  `COLLECT_VALUES` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '选项值，可以为多个，以json方式存储',
  `INSURED_REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '被保人备注',
  `INSURED_RESULT` int(11) DEFAULT NULL COMMENT '被保人采集结果',
  `POLICYHOLDER_REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '投保人备注',
  `POLICYHOLDER_RESULT` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '投保人采集结果',
...
CREATE TABLE `insurance_order_insured`  (
  ...
  `INSURED_HEIGHT` int(11) DEFAULT NULL COMMENT '被保人身高',
  `INSURED_BODY_WEIGHT` float DEFAULT NULL COMMENT '被保人体重',
  `INSURED_INCOME` int(255) DEFAULT NULL COMMENT '被保人收入',
  `INSURED_MARRIAGE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '被保人婚否',
  `INSURED_TEL` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '被保人固定电话',
  `INSURED_MOBILE` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '被保人手机号',
  `INSURED_EMAIL` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '被保人邮箱',
...
CREATE TABLE `insurance_order_offsite`  (
  ...
  `WORKPLACE` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工作相关',
  ...
  `OTHER_MATTER` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '其他事项',
...
CREATE TABLE `insurance_order_policyholder`  (
  ...
  `POLICYHOLDER_HEIGHT` int(11) DEFAULT NULL COMMENT '投保人身高',
  `POLICYHOLDER_BODY_WEIGHT` float DEFAULT NULL COMMENT '投保人体重',
  `POLICYHOLDER_INCOME` int(255) DEFAULT NULL COMMENT '投保人收入',
  `POLICYHOLDER_MARRIAGE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '投保人婚否',
  `POLICYHOLDER_TEL` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '投保人固定电话',
  `POLICYHOLDER_MOBILE` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '投保人手机号',
  ...
  `OTHER_IMG1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '其他资料1',
  `OTHER_IMG2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '其他资料2',
  `OTHER_IMG3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '其他资料3',
  `POLICYHOLDER_AVATAR` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '投保人头像',
  `SUBMISSION_SIGN` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '签名',
...
CREATE TABLE `insurance_product`  (
  ...
  `DESCRIPTION` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '产品描述',
  ...
  `TAGS` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '标签（多个用逗号隔开）',
...
CREATE TABLE `key_word`  (
  ...
  `KEY_KEY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `letter`  (
  ...
  `CREATE_TIME` datetime DEFAULT NULL,
  `LETTER_CONTENT` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `logistic`  (
  ...
  `PROVINCE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `QQ` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TELEPHONE` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `URL` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `WE_CHAT_NO` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SELLER_ID` int(11) NOT NULL,
...
CREATE TABLE `logistic_price`  (
  ...
  `CITY_CODES` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `mails`  (
  ...
  `CONTENT` varchar(3000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `order_form`  (
  ...
  `BARTER_STATE` int(11) DEFAULT NULL,
  `BUYER_MESSAGE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CANCEL_REASON` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CANCEL_TIME` datetime DEFAULT NULL,
  `CITY` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `CONSIGNEE_ADDRESS` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `CONSIGNEE_MOBILE` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CONSIGNEE_NAME` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `CONSIGNEE_TELEPHONE` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `COUPONS_FEE` double NOT NULL,
  `COURIER_NUMBER` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CREATE_TIME` datetime DEFAULT NULL,
  `DELIVERY` bit(1) NOT NULL,
  `DELIVERY_FEE_TOTAL` double NOT NULL,
  `DELIVERY_STATE` int(11) DEFAULT NULL,
  `DELIVERY_TYPE` int(11) NOT NULL,
  `DISCOUNT_DELIVERY_FEE_TOTAL` double DEFAULT NULL,
  `DISCOUNT_TOTAL` double DEFAULT NULL,
  `DISTRICT` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ENABLED` bit(1) NOT NULL,
  `FEE_TOTAL` double DEFAULT NULL,
  `FINISH_TIME` datetime DEFAULT NULL,
  `ORDER_CODE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ORDER_STATE` int(11) NOT NULL,
  `ORIGIN_ORDER_CODE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PAY_BY_INTEGRAL` double DEFAULT NULL,
  `PAYMENT_SEQUENCE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `PROVINCE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `RETURN_REFUND_STATE` int(11) DEFAULT NULL,
  `SCORE_TOTAL` int(11) NOT NULL,
  `TOTAL_PRICE` double NOT NULL,
  `UPDATE_TIME` datetime DEFAULT NULL,
  `USED_SCORE` int(11) DEFAULT NULL,
...
CREATE TABLE `order_invoice`  (
  ...
  `REGISTER_ADDRESS` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `REGISTER_PHONE` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TAXPAYER_NO` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `order_item`  (
  ...
  `ORDER_ITEM_PRICE` float NOT NULL,
  `PRODUCT_IMG` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `payment`  (
  ...
  `BUYER_ACCOUNT` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CHANNEL_TYPE` int(11) NOT NULL,
  `COMPLETE_TIME` datetime DEFAULT NULL,
  `CREATE_TIME` datetime DEFAULT NULL,
  `ERROR_CODE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `PAY_NOTIFY_STATE` int(11) DEFAULT NULL,
  `PAY_STATE` int(11) NOT NULL,
  `PAY_TYPE` int(11) NOT NULL,
  `REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CUSTOMER_ID` int(11) DEFAULT NULL,
  `ORDER_ID` int(11) DEFAULT NULL,
  `BATCH_NO` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `BATCH_NUM` int(11) DEFAULT NULL,
  `RETURN_CODE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product`  (
  ...
  `CREATE_TIME` datetime DEFAULT NULL,
  `DEFAULT_PIC_PATH` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product_barter`  (
  ...
  `CONSIGNEE_INFO_CONSIGNEE_MOBILE` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CONSIGNEE_INFO_CONSIGNEE_NAME` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `CONSIGNEE_INFO_CONSIGNEE_TELEPHONE` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CONSIGNEE_INFO_DISTRICT` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `CONSIGNEE_INFO_POST_CODE` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CONSIGNEE_INFO_PROVINCE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `CONSIGNEE_INFO_REMARK` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PIC_PATH` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PURCHASING_TIME` datetime DEFAULT NULL,
  ...
  `LOGISTIC_CODE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `RECEIVED_SELLER_PRODUCT` bit(1) DEFAULT NULL,
...
CREATE TABLE `product_change_price`  (
  ...
  `AUDIT_OPINION` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product_return`  (
  ...
  `DISPOSE_TIME` datetime DEFAULT NULL,
  `LOGISTIC_CODE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `REASON_REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `RECEIVED_BUYER_PRODUCT` bit(1) DEFAULT NULL,
  `RECEIVED_SELLER_PRODUCT` bit(1) DEFAULT NULL,
...
CREATE TABLE `profile`  (
  ...
  `FILE_VALUE` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '值',
...
CREATE TABLE `programa`  (
  ...
  `RECOMMEND` bit(1) NOT NULL,
  `SEO_DESCRIPTION` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SEO_KEY` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SEO_TITLE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SORT_ORDER` int(11) NOT NULL,
  `CHANNEL_ID` int(11) NOT NULL,
  `TEMPLATE_NAME` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `recipe`  (
  ...
  `CONDIMENT` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `COOKING_METHOD` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CUISINE_TYPE` int(11) NOT NULL,
  `DETAILED_STEPS` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `FOOD_MATERIAL_DETAILS` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PRECAUTIONS` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PRODUCTION_DIFFICULTY_TYPE` int(11) NOT NULL,
  `RECIPE_NAME` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `RELATED_GROUPS` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TASTE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TIME_NEEDED` int(11) DEFAULT NULL,
  `TIPS` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CUSTOMER_ID` int(11) NOT NULL,
  `RECIPE_CODE` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `role_resc`  (
  ...
  `RESC_CODE` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ROLE_ID` int(11) NOT NULL,
...
CREATE TABLE `seller`  (
  ...
  `AGREEMENT_PIC_PATH` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `BUSLICENSE_PIC_PATH` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `ENABLED` bit(1) NOT NULL,
  `HOLD_ID_POTO_PIC_PATH` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `MOBILE` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `POSITIVE_ID_POTO_PIC_PATH` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `TELEPHONE` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `WECHAT` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `share`  (
  ...
  `MEDIA_KEY` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `sms_log`  (
  ...
  `SMS_REMARK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `system_letter`  (
  ...
  `RECIPIENT` varchar(5000) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `system_log`  (
  ...
  `ARG_NAMES` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `CREATE_TIME` datetime DEFAULT NULL,
  `METHOD_NAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `OPERATE_TYPE` int(11) DEFAULT NULL,
  `REMARK` varchar(1024) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `RETURNING` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `USER_ID` int(11) NOT NULL,
...
CREATE TABLE `user_info`  (
  ...
  `POSITION` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `REAL_NAME` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `REMARK` varchar(1024) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `SEX` bit(1) DEFAULT NULL,
