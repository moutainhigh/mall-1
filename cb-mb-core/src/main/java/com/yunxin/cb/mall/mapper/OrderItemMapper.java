...
public interface OrderItemMapper {
    String columns = "ITEM_ID, BUYER_MESSAGE, CREATE_TIME, EVALUATE, ORDER_ITEM_PRICE, PRODUCT_IMG, PRODUCT_NUM, SALE_PRICE, ACTIVITY_ID, ORDER_ID, PRODUCT_ID, COST_PRICE";
    /**
