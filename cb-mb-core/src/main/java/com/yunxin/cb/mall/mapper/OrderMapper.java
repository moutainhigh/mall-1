...
public interface OrderMapper {
     ...
     */
    @Insert({
        "insert into order_form (ORDER_ID, BARTER_STATE, ",
        "BUYER_MESSAGE, CANCEL_REASON, ",
        "CANCEL_TIME, CITY, ",
        "CONSIGNEE_ADDRESS, CONSIGNEE_MOBILE, ",
        "CONSIGNEE_NAME, CONSIGNEE_TELEPHONE, ",
        "COUPONS_FEE, COURIER_NUMBER, ",
        "CREATE_TIME, DELIVERY, ",
        "DELIVERY_FEE_TOTAL, DELIVERY_STATE, ",
        "DELIVERY_TYPE, DISCOUNT_DELIVERY_FEE_TOTAL, ",
        "DISCOUNT_TOTAL, DISTRICT, ",
        "ENABLED, FEE_TOTAL, FINISH_TIME, ",
        "ORDER_CODE, ORDER_STATE, ",
        "ORIGIN_ORDER_CODE, PAY_BY_INTEGRAL, ",
        "PAYMENT_SEQUENCE, PAYMENT_TIME, ",
        "PAYMENT_TYPE, POST_CODE, ",
        "PROD_QUANTITY, PROVINCE, ",
        "REMARK, RETURN_REFUND_STATE, ",
        "SCORE_TOTAL, TOTAL_PRICE, ",
        "UPDATE_TIME, USED_SCORE, ",
        "VOLUME_TOTAL, WEIGHT_TOTAL, ",
        "CUSTOMER_ID, LOGISTIC_ID, ",
        "SELLER_ID)",
    ...
    @Select({
        "select",
        "ORDER_ID, BARTER_STATE, BUYER_MESSAGE, CANCEL_REASON, CANCEL_TIME, CITY, CONSIGNEE_ADDRESS, ",
