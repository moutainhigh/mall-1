...
public interface OrderMapper {
    ...
    final static String columns = "ORDER_ID, BARTER_STATE, BUYER_MESSAGE, CANCEL_REASON, CANCEL_TIME, CITY, CONSIGNEE_ADDRESS," +
            ...
            " LOGISTIC_ID, SELLER_ID, AUDIT_STATE, AUDIT_REMARK, AUDIT_TIME, DELIVER_TIME, COLLECT_TIME, PAYMENT_STATE";
    ...
    @Insert({
        ...
        "#{sellerId,jdbcType=INTEGER},#{auditState,jdbcType=INTEGER}, ",
        "#{auditRemark,jdbcType=VARCHAR}, #{auditTime,jdbcType=TIMESTAMP},",
        "#{deliverTime,jdbcType=VARCHAR}, #{collectTime,jdbcType=TIMESTAMP},",
