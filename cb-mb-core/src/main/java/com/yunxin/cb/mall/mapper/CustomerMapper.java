...
public interface CustomerMapper {
    ...
    @Insert({
        ...
        "#{birthday,jdbcType=TIMESTAMP}, #{cardNo,jdbcType=VARCHAR}, ",
        ...
        "#{praise,jdbcType=INTEGER}, #{praiseNum,jdbcType=INTEGER})"
    })
    ...
    @Select({
        "select",
        "CUSTOMER_ID, ACCOUNT_NAME, ADDRESS, NICK_NAME, BIRTHDAY, CARD_NO, CITY, CREATE_TIME, ",
        "CUSTOMER_TYPE, DISTRICT, EMAIL, ENABLED, EXCHANGE_INTEGRAL, INTEGRAL, MAIL_CHECKED, ",
        "MOBILE, MOBILE_CHECKED, PASSWORD, POST_CODE, PROVINCE, QQ_ACCESS_TOKEN, QQ_FIGURE_URL, ",
        "QQ_NICK_NAME, QQ_OPEN_ID, REAL_NAME, REMARK, SEX, TELEPHONE, TOTAL_INTEGRAL, ",
        "RANK, EMAIL_CHECKED, RONG_CLOUD_TOKEN, AVATAR_URL, RECOMMEND_CUSTOMER_ID, PRAISE, ",
        "PRAISE_NUM",
        "from customer",
        "where CUSTOMER_ID = #{customerId,jdbcType=INTEGER}"
    })
