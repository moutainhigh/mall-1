...
public interface CustomerWalletMapper {
     ...
     */
    @Insert({
        "insert into customer_wallet (CUSTOMER_ID, AVAILABLE_BALANCE, ",
        "EXPECTED_RETURN_AMOUNT, LOAN_QUOTA, ",
        "ARREARS_AMOUNT, CREATE_TIME, ",
        "UPDATE_TIME)",
        "values (#{customerId,jdbcType=INTEGER}, #{availableBalance,jdbcType=DOUBLE}, ",
    ...
    @Select({
        "select",
        "CUSTOMER_ID, AVAILABLE_BALANCE, EXPECTED_RETURN_AMOUNT, LOAN_QUOTA, ARREARS_AMOUNT, ",
    ...
    CustomerWallet selectByPrimaryKey(Integer customerId);
    ...
    @Update({
        ...
        "set AVAILABLE_BALANCE = #{availableBalance,jdbcType=DOUBLE},",
