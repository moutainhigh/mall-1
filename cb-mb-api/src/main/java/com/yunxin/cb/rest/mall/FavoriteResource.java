...
public class FavoriteResource extends BaseResource {
    ...
    public ResponseResult getCustomerFavorite(@ModelAttribute("customerId") int customerId){
    ...
    public ResponseResult addFavorite(@RequestParam(value = "commodityId") int commodityId,@ModelAttribute("customerId") int customerId){
        return new ResponseResult(null);
    }
    ...
    public ResponseResult delFavorite(@RequestParam(value = "commodityId") int commodityId,@ModelAttribute("customerId") int customerId){
        return new ResponseResult(null);
    }
}