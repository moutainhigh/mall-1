	...
	return function(t) {
		...
		t.exports = function(t, e, n, d, v, y, m) {
			...
			var g, b, _, x = function(t) {
				...
				k = !1,
				C = t.prototype,
				P = C[l] || C["@@iterator"] || v && C[v],
				O = P || x(v),
				M = v ? S ? x("entries") : O : void 0,
			...
			if(U && (_ = f(U.call(new t))) !== Object.prototype && _.next && (c(_, w, !0), r || "function" == typeof _[l] || u(_, l, h)), S && P && "values" !== P.name && (k = !0, O = function() {
					return P.call(this)
				}), r && !m || !p && !k && C[l] || u(C, l, O), s[e] = O, s[w] = h, v)
				if(g = {
						values: S ? O : x("values"),
						keys: y ? O : x("keys"),
						entries: M
		...
		var r, o, i, u, s = n(12),
			...
			T = function(t) {
				m.call(a, function() {
					var e;
					M ? k.emit("rejectionHandled", t) : (e = a.onrejectionhandled) && e({
						promise: t,
						reason: t._v
					})
				})
		...
		A || (O = function(t) {
			...
			Promise: O
		}), n(21)(O, "Promise"), n(79)("Promise"), u = n(1).Promise, l(l.S + l.F * !A, "Promise", {
			reject: function(t) {
				var e = E(this);
		...
		r = function(t) {
			...
			return u(o("hello")), "undefined" == typeof ArrayBuffer || ArrayBuffer.prototype.slice || function() {
				...
				var n, o, i, u, s, a = (o = this._buff.buffer, i = t, u = !0, (s = new Uint8Array(o.byteLength + i.byteLength)).set(new Uint8Array(o)), s.set(new Uint8Array(i), o.byteLength), u ? s : s.buffer),
					c = a.length;
		...
		var r = n(0),
			...
			W = function(t, e, n) {
				return t === z && W(B, e, n), g(t), e = x(e, !0), g(n), o(q, e) ? (n.enumerable ? (o(t, F) && t[F][e] && (t[F][e] = !1), n = S(n, {
					enumerable: w(0, !1)
				})) : (o(t, F) || U(t, F, w(1, {})), t[F][e] = !0), G(t, e, n)) : U(t, e, n)
			},
			X = function(t, e) {
				g(t);
