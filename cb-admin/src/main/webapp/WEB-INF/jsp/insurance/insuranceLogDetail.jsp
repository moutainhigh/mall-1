    ...
    <div id="content" class="clearfix">
        ...
        <header id="header-sec">
            <div class="inner-padding">
                ...
                <div class="pull-right">
                    <a class="btn btn-default" href="insuranceLog.do">
            ...
            <div class="tab-content">
                ...
                <div id="content-tab-2" class="tab-pane">
                    ...
                    <div class="btn-group"  style="margin-left: 150px;">
                        <a class="btn btn-default pull-right" href="insuranceLog.do">返回</a>
                    </div>
                </div>
                ...
                <div id="content-tab-3" class="tab-pane">
                    ...
                    <%--<c:if test="${insuranceOrder.insuranceOrderOffsite!=null}">--%>
                        <%--&lt;%&ndash;<button id="saveBtn" class="btn btn-default" type="submit"><i class="fa fa-save"></i>&nbsp;保&nbsp;存&nbsp;</button>&ndash;%&gt;--%>
