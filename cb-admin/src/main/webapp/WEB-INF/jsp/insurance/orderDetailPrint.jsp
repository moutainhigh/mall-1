...
<div id="main" class="clearfix">
                ...
                <div class="hidden-prints" style="height:3751px;">
                    ...
                    <div class="div-tab">
                        <div class="div-line">
                            ...
                            <div class="div-line-con div-sex">
                                ...
                                <div>
                                    <input class="i-cb" type="checkbox" style="margin-left: 15px;" <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredGender=='true'}">checked</c:if>/>
                                    男
                                    <input class="i-cb" style="margin-left: 35px; " type="checkbox"  <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredGender=='false'}">checked</c:if>/>
                                    女
                                </div>
                            </div>
                            <div class="div-line-con div-row-4">
                                ...
                                <div style="padding-left: 40px;margin-left: 30px;">
                                    <input class="b-input" type="text" value="${map.insurance_b_year}"/>
                                    年
                                    <input class="b-input" type="text" value="${map.insurance_b_month}"/>
                                    月
                                    <input class="b-input" type="text" value="${map.insurance_b_day}"/>
                                    日
                                </div>
                            </div>
                            <div class="div-line-con div-row-2">
                                <div class="title">A 4.年龄</div>
                                <input class="c-input" type="text" value="${map.age}"/>
                                <div>周岁</div>
                            </div>
                        </div>
                        ...
                        <div class="div-line">
                            <div class="div-line-con div-row-5">
                                ...
                                <div>
                                    <input class="i-cb" type="checkbox" <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredMarriage=='居民身份证'}">checked</c:if>/>
                                    身份证
                                    <input class="i-cb" type="checkbox" style="margin-left:15px; " <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredMarriage=='护照'}">checked</c:if>/>
                                    护照
                                    <input class="i-cb" type="checkbox" style="margin-left:15px; " <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredMarriage=='军官证'}">checked</c:if>/>
                                    军官证
                                    <input class="i-cb" type="checkbox" style="margin-left:15px; " <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredMarriage!='军官证'&&map.insuranceOrder.insuranceOrderInsured.insuredMarriage!='护照'&&map.insuranceOrder.insuranceOrderInsured.insuredMarriage!='居民身份证'}">checked</c:if>/>
                                    其他
                                </div>
                            </div>
                        ...
                        <div class="div-line">
                            <div class="div-line-con div-row-5">
                                ...
                                <div>
                                    <input class="i-cb" type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_p_year!=null&&map.insurance_p_year!=''}">checked</c:if>/>
                                    有效期至
                                    <div>
                                        <input class="c-input" type="text" style="margin-left: 10px;" value="${map.insurance_p_year}"/>
                                        年
                                        <input class="c-input" type="text" value="${map.insurance_p_month}"/>
                                        月
                                        <input class="c-input" type="text" value="${map.insurance_p_day}"/>
                                        日
                                    </div>
                                    <input class="i-cb" style="margin-left: 15px" type="checkbox" ${map.insurance_p_year==null||map.insurance_p_year==''}/>
                                    长期
                                </div>
                            </div>
                            <div class="div-line-con div-row-3">
                                <div class="title">A 8.国籍、户籍</div>
                                <input class="a-input" type="text" value="${map.insuranceOrder.insuranceOrderInsured.insuredCountry}"/>
                            </div>
                            <div class="div-line-con div-row-3">
                                <div class="title">A 9.身高</div>
                                <input class="b-input" type="text" style="margin-left: 10px;" value="${map.insuranceOrder.insuranceOrderInsured.insuredHeight}"/>
                                厘米，
                                <div class="title">体重</div>
                                <input class="b-input" type="text" style="margin-left: 5px;" value="${map.insuranceOrder.insuranceOrderInsured.insuredBodyWeight}"/>
                                公斤
                            </div>
                        </div>
                        <div class="div-line">
                            <div class="div-line-con div-row-5">
                                ...
                                <div>
                                    <input class="i-cb" type="checkbox" style="margin-left: 14px;" <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredMarriage=='未婚'}">checked</c:if>/>
                                    未婚
                                    <input class="i-cb" type="checkbox" style="margin-left: 20px;" <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredMarriage=='已婚'}">checked</c:if>/>
                                    已婚
                                    <input class="i-cb" type="checkbox" style="margin-left: 20px;" <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredMarriage=='离异'}">checked</c:if>/>
                                    离异
                                    <input class="i-cb" type="checkbox" style="margin-left: 25px;" <c:if test="${map.insuranceOrder.insuranceOrderInsured.insuredMarriage=='丧偶'}">checked</c:if>/>
                                    丧偶
                                </div>
                            </div>
                            <div class="div-line-con div-row-3">
                                <div class="title">A 11.固定电话（<input class="b-input" type="text" value="${map.insurance_q_tel}"/>)-(<input
                                        class="mobile-input" type="text" value="${map.insurance_h_tel}"/></span>)
                                </div>
                            </div>
                            <div class="div-line-con div-row-3">
                                <div class="title">A 12.移动电话</div>
                                <input class="a-input" type="text" value="${map.insuranceOrder.insuranceOrderInsured.insuredMobile}"/>
                            </div>
                        </div>
                        ...
                        <div class="div-line">
                            <div class="div-line-con div-row-7">
                                ...
                                <div>
                                    <input class="b-input" type="text" style="margin-left: 10px;" id="insuredProvince"/>
                                    省
                                    <input class="b-input" type="text" style="margin-left: 10px;" id="insuredCity"/>
                                    市
                                    <input class="b-input" type="text" style="margin-left: 25px;" id="insuredDistrict"/>
                                    区/县
                                    <input class="d-input" type="text" value="${map.insuranceOrder.insuranceOrderInsured.insuredAddress}"/>
                                </div>
                            </div>
                            <div class="div-line-con div-postcode" style="margin-right: 40px;">
                                邮编
                                <div style="margin-left: 20px;font-size: 0;margin-top: -10px;">
                                    <input class="i-cert-code" style="border: #000000 solid 1px !important" value="5"/>
                                    <input class="i-cert-code" style="border: #000000 solid 1px !important" value="1"/>
                                    <input class="i-cert-code" style="border: #000000 solid 1px !important" value="8"/>
                                    <input class="i-cert-code" style="border: #000000 solid 1px !important" value="0"/>
                                    <input class="i-cert-code" style="border: #000000 solid 1px !important" value="0"/>
                                    <input class="i-cert-code" style="border: #000000 solid 1px !important" value="0"/>
                                </div>
                            </div>
                        ...
                        <div class="div-line">
                            ...
                            <div class="div-line-con div-row-3">
                                ...
                                <%--<input class="a-input" type="text" value="" id=""/>--%>
                                <div  style="float: left;width: 200px;font-size: 10px;"id="insuredCareer"></div>
                            </div>
                            <div class="div-line-con div-row-3">
                                <div class="title">A 16.年均收入</div>
                                <input class="a-input" type="text" value="${map.insuranceOrder.insuranceOrderInsured.insuredIncome}"/>
                            </div>
                        </div>
                        <div class="div-line">
                            <div class="div-line-con div-row-7">
                        ...
                        <div class="div-line">
                            ...
                            <div class="div-line-con div-email">
                                ...
                                <input class="a-input" type="text" value="${map.insuranceOrder.insuranceOrderInsured.insuredEmail}"/>
                            </div>
                    ...
                    <div class="div-tab">
                        <div class="div-line">
                            ...
                            <div class="div-line-con div-sex">
                                ...
                                <div>
                                    <input class="i-cb" type="checkbox" style="margin-left: 10px; " <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderGender=='true'}">checked</c:if>/>
                                    男
                                    <input class="i-cb" style="margin-left: 30px; " type="checkbox" <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderGender=='false'}">checked</c:if>/>
                                    女
                                </div>
                            </div>
                            <div class="div-line-con div-row-4">
                                ...
                                <div style="padding-left: 0; margin-left: 55px;">
                                    <input class="b-input" type="text" value="${map.policy_b_year}"/>
                                    年
                                    <input class="b-input" type="text" value="${map.policy_b_month}"/>
                                    月
                                    <input class="b-input" type="text" value="${map.policy_b_day}"/>
                                    日
                                </div>
                            </div>
                            <div class="div-line-con div-row-2">
                                <div class="title">A 24.是被保险人的(<span style="font-size: 8px;">关系</span>)</div>
                                <input class="c-input" type="text" style="" value="${map.insuranceOrder.insuranceOrderInsured.insuredRelation}"/>
                                <div></div>
                            </div>
                        </div>
                        ...
                        <div class="div-line">
                            <div class="div-line-con div-row-5">
                                ...
                                <div>
                                    <input class="i-cb" type="checkbox" <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage=='居民身份证'}">checked</c:if>/>
                                    身份证
                                    <input class="i-cb" type="checkbox" style="margin-left:15px; "  <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage=='护照'}">checked</c:if>/>
                                    护照
                                    <input class="i-cb" type="checkbox" style="margin-left:15px; "  <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage=='军官证'}">checked</c:if>/>
                                    军官证
                                    <input class="i-cb" type="checkbox" style="margin-left:15px; "  <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage!='军官证'&&map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage!='护照'&&map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage!='居民身份证'}">checked</c:if>/>
                                    其他
                                </div>
                            </div>
                            <div class="div-line-con">
                        ...
                        <div class="div-line">
                            <div class="div-line-con div-row-5">
                                ...
                                <div>
                                    <input class="i-cb" type="checkbox" style="margin-left: 10px;" <c:if test="${map.policy_p_year!=null&&map.policy_p_year!=''}">checked</c:if>/>
                                    有效期至
                                    <div style="margin-left: 10px;">
                                        <input class="c-input" type="text" value="${map.policy_p_year}"/>
                                        年
                                        <input class="c-input" type="text" value="${map.policy_p_month}"/>
                                        月
                                        <input class="c-input" type="text" value="${map.policy_p_day}"/>
                                        日
                                    </div>
                                    <input class="i-cb" style="margin-left: 10px" type="checkbox" <c:if test="${map.policy_p_year==null&&map.policy_p_year==''}">checked</c:if>/>
                                    长期
                                </div>
                            </div>
                            <div class="div-line-con div-row-3">
                                <div class="title">A 28.国籍、户籍</div>
                                <input class="a-input" type="text" value="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderCountry}"/>
                            </div>
                            <div class="div-line-con div-row-3">
                                <div class="title">A 29.身高</div>
                                <input class="b-input" type="text" style="margin-left: 10px;" value="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderHeight}"/>
                                厘米，
                                <div class="title">体重</div>
                                <input class="b-input" type="text" style="margin-left: 10px;" value="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderBodyWeight}"/>
                                公斤
                            </div>
                        </div>
                        <div class="div-line">
                            <div class="div-line-con div-row-5">
                                ...
                                <div>
                                    <input class="i-cb" type="checkbox" style="margin-left: 15px;" <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage=='未婚'}">checked</c:if>/>
                                    未婚
                                    <input class="i-cb" type="checkbox" style="margin-left: 23px;" <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage=='已婚'}">checked</c:if>/>
                                    已婚
                                    <input class="i-cb" type="checkbox" style="margin-left: 23px;" <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage=='离异'}">checked</c:if>/>
                                    离异
                                    <input class="i-cb" type="checkbox" style="margin-left: 23px;" <c:if test="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderMarriage=='丧偶'}">checked</c:if>/>
                                    丧偶
                                </div>
                            </div>
                            <div class="div-line-con div-row-3">
                                <div class="title">A 31.固定电话（<input class="b-input"
                            ...
                            <div class="div-line-con div-row-3">
                                ...
                                <input class="a-input" type="text" value="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderMobile}"/>
                            </div>
                        </div>
                        ...
                        <div class="div-line">
                            <div class="div-line-con div-row-7">
                                ...
                                <div>
                                    <input class="b-input" type="text" style="margin-left:40px; " id="policyholderProvince"/>
                                    省
                                    <input class="b-input" type="text" style="margin-left: 30px;" id="policyholderCity"/>
                                    市
                                    <input class="b-input" type="text" style="margin-left: 20px;" id="policyholderDistrict"/>
                                    区/县
                                    <input class="d-input" type="text" value="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderAddress}"/>
                                </div>
                            </div>
                            <div class="div-line-con div-postcode" style="margin-right: 40px;">
                                邮编
                        ...
                        <div class="div-line">
                            <div class="div-line-con div-row-5">
                                ...
                                <input class="a-input" type="text" value=""/>
                            </div>
                            <div class="div-line-con div-row-3">
                            ...
                            <div class="div-line-con div-row-3">
                                ...
                                <input class="a-input" type="text" value="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderIncome}"/>
                            </div>
                        </div>
                        <div class="div-line">
                            <div class="div-line-con div-row-7">
                        ...
                        <div class="div-line">
                            ...
                            <div class="div-line-con div-email">
                                ...
                                <input class="a-input" type="text" value="${map.insuranceOrder.insuranceOrderPolicyholder.policyholderEmail}"/>
                            </div>
                            <div class="div-line-con div-part-job">
                    ...
                    <div class="div-tab">
                        <div class="div-line">
                            <div class="div-line-con" style="padding: 7px 5px 7px 10px;">
                                A 41. 信函寄往
                                <div > <input class="a-input" type="text" id="policyholderProvinces" style="width: 60px;"/>省</div>
                                <div><input class="a-input" type="text" id="policyholderCitys"  style="width: 80px;"/>市</div>
                                <div><input class="a-input" type="text" id="policyholderDistricts"  style="width: 70px;"/>区/县</div>
                    ...
                    <div class="div-tab" style="height: 240px;width: 1000px;">
                        ...
                        <div class="table-line">
                            ...
                            <div class="div-table-2">
                                <div class="t-line" style="padding: 5px 6px;">
                                    <input type="checkbox" <c:if test="${map.beneficiaryList[0].beneficiaryCardType=='居民身份证'}">checked</c:if>/>
                                    <div>身份证</div>
                                    <input type="checkbox" style="margin-left: 15px;" <c:if test="${map.beneficiaryList[0].beneficiaryName!=null&&''!=map.beneficiaryList[0].beneficiaryName&&map.beneficiaryList[0].beneficiaryCardType!='居民身份证'}">checked</c:if>/>
                                    <div>其他</div>
                                    ...
                                    <input class="i-cb" style="margin-left: 55px;" type="checkbox" <c:if test="${map.beneficiaryList[0].beneficiaryCardType=='长期'}">checked</c:if>/>
                                    长期
                                </div>
                        ...
                        <div class="table-line">
                            ...
                            <div class="div-table-2">
                                <div class="t-line" style="padding: 5px 6px;">
                                    <input type="checkbox" <c:if test="${map.beneficiaryList[1].beneficiaryCardType=='居民身份证'}">checked</c:if>/>
                                    <div>身份证</div>
                                    <input type="checkbox" style="margin-left: 15px;" <c:if test="${map.beneficiaryList[1].beneficiaryName!=null&&''!=map.beneficiaryList[1].beneficiaryName&&map.beneficiaryList[1].beneficiaryCardType!='居民身份证'}">checked</c:if>/>
                                    <div>其他</div>
                                    <div style="margin:0 60px;margin-left: 130px;">有效期至
    ...
    <input class="i-cb" style="margin-left: 55px;" type="checkbox" <c:if test="${map.beneficiaryList[1].beneficiaryCardType=='长期'}">checked </c:if>/>
                                    长期
                                </div>
                                <div class="t-line" style="display: block;height: 31px;">
                        ...
                        <div class="table-line">
                            ...
                            <div class="div-table-2">
                                <div class="t-line" style="padding: 6px;">
                                    <input type="checkbox" <c:if test="${map.beneficiaryList[2].beneficiaryCardType=='居民身份证'}">checked</c:if>/>
                                    <div>身份证</div>
                                    <input type="checkbox" style="margin-left: 15px;" <c:if test="${map.beneficiaryList[2].beneficiaryName!=null&&''!=map.beneficiaryList[2].beneficiaryName&&map.beneficiaryList[2].beneficiaryCardType!='居民身份证'}">checked</c:if>/>
                                    <div>其他</div>
                                    <div style="margin:0 60px;margin-left: 130px;">有效期至
                                    ...
                                    <input class="i-cb" style="margin-left: 55px;" type="checkbox" <c:if test="${map.beneficiaryList[2].beneficiaryCardType=='长期'}">checked </c:if>/>
                                    长期
                                </div>
                                <div class="t-line" style="display: block;height: 31px;">
                                    <div style="display: inline-block;height: 30px;font-size: 0;border-top: #000000 solid 1px;width: 100%;margin:0 -1px;text-align: left">
                    ...
                    <div class="div-tab">
                        ...
                        <div class="table-line" style="height: 53px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height: 53px;"><input type="checkbox" <c:if test="${map.insurance_matterList[0].insuredResult=='true'}">checked</c:if>  >是
                                <input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[0].insuredResult=='false'}">checked</c:if>   >否
                            </div>
                            <div class="div-table-2" style="width: 83px;height: 53px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[0].policyholderResult=='true'}">checked</c:if> >是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[0].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 53px;">
                            <div class="div-table-2"
                            ...
                            <div class="div-table-2" style="width: 83px;height: 53px;"><input type="checkbox" <c:if test="${map.insurance_matterList[1].insuredResult=='true'}">checked</c:if>>是<input
                                    type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[1].insuredResult=='false'}">checked</c:if>>否
                            </div>
                            <div class="div-table-2" style="width: 83px;height: 53px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[1].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[1].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 53px;">
                            <div class="div-table-2"
                            ...
                            <div class="div-table-2" style="width: 83px;height: 53px;"><input type="checkbox" <c:if test="${map.insurance_matterList[2].insuredResult=='true'}">checked</c:if>>是<input
                                    type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[2].insuredResult=='false'}">checked</c:if>>否
                            </div>
                            <div class="div-table-2" style="width: 83px;height: 53px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[2].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[2].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 25px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height: 25px;"><input type="checkbox" <c:if test="${map.insurance_matterList[3].insuredResult=='true'}">checked</c:if>>是<input
                            ...
                            <div class="div-table-2" style="width: 83px;height: 25px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[3].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[3].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 60px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height: 60px;"><input type="checkbox" <c:if test="${map.insurance_matterList[4].insuredResult=='true'}">checked</c:if>>是<input
                            ...
                            <div class="div-table-2" style="width: 83px;height: 60px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[4].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[4].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 30px;">
                            <div class="div-table-2"
                            ...
                            <div class="div-table-2" style="width: 83px;height: 30px;"><input type="checkbox" <c:if test="${map.insurance_matterList[5].insuredResult=='true'}">checked</c:if>>是<input
                            ...
                            <div class="div-table-2" style="width: 83px;height: 30px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[5].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[5].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 30px;">
                            <div class="div-table-2"
                            ...
                            <div class="div-table-2" style="width: 83px;height: 30px;"><input type="checkbox" <c:if test="${map.insurance_matterList[6].insuredResult=='true'}">checked</c:if>>是<input
                                    type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[6].insuredResult=='false'}">checked</c:if>>否
                            </div>
                            <div class="div-table-2" style="width: 83px;height: 30px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[6].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[6].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 60px;">
                            <div class="div-table-2"
                            ...
                            <div class="div-table-2" style="width: 83px;height: 60px;"><input type="checkbox" <c:if test="${map.insurance_matterList[7].insuredResult=='true'}">checked</c:if>>是<input
                                    type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[7].insuredResult=='false'}">checked</c:if>>否
                            </div>
                            <div class="div-table-2" style="width: 83px;height: 60px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[7].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[7].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 160px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height: 160px;"><input type="checkbox" <c:if test="${map.insurance_matterList[8].insuredResult=='true'}">checked</c:if>>是<input
                            ...
                            <div class="div-table-2" style="width: 83px;height: 160px;border-right:#000000 1px solid;">
                                <input type="checkbox" <c:if test="${map.insurance_matterList[8].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[8].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 53px;">
                            <div class="div-table-2"
                            ...
                            <div class="div-table-2" style="width: 83px;height: 53px;"><input type="checkbox" <c:if test="${map.insurance_matterList[9].insuredResult=='true'}">checked</c:if>>是<input
                                    type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[9].insuredResult=='false'}">checked</c:if>>否
                            </div>
                            <div class="div-table-2" style="width: 83px;height: 53px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[9].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[9].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="div-tab">
                        <div class="table-line" style="height: 58px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height:58px;"><input type="checkbox" <c:if test="${map.insurance_matterList[10].insuredResult=='true'}">checked</c:if>>是<input
                            ...
                            <div class="div-table-2" style="width: 83px;height:58px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[10].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[10].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 465px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height: 465px;vertical-align: top">
                                <div style="display: block;margin-top:25px;"><input type="checkbox" <c:if test="${map.insurance_matterList[11].insuredResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[11].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:125px;"><input type="checkbox" <c:if test="${map.insurance_matterList[12].insuredResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[12].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:0;"><input type="checkbox" <c:if test="${map.insurance_matterList[13].insuredResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                                         style="margin-left: 10px;" <c:if test="${map.insurance_matterList[13].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:15px;"><input type="checkbox" <c:if test="${map.insurance_matterList[14].insuredResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[14].insuredResult=='true'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[15].insuredResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[15].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:15px;"><input type="checkbox" <c:if test="${map.insurance_matterList[16].insuredResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[16].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:15px;"><input type="checkbox" <c:if test="${map.insurance_matterList[17].insuredResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[17].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[18].insuredResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[18].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[19].insuredResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[19].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:15px;"><input type="checkbox" <c:if test="${map.insurance_matterList[20].insuredResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[20].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[21].insuredResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[21].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[22].insuredResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[22].insuredResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[23].insuredResult=='true'}">checked</c:if>>是<input type="checkbox"
                            ...
                            <div class="div-table-2"
                                ...
                                <div style="display: block;margin-top:25px;"><input type="checkbox" <c:if test="${map.insurance_matterList[11].policyholderResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px; " <c:if test="${map.insurance_matterList[11].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:125px;"><input type="checkbox" <c:if test="${map.insurance_matterList[12].policyholderResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[12].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:0;"><input type="checkbox" <c:if test="${map.insurance_matterList[13].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                                         style="margin-left: 10px;" <c:if test="${map.insurance_matterList[13].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:15px;"><input type="checkbox" <c:if test="${map.insurance_matterList[14].policyholderResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[14].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[15].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[15].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:15px;"><input type="checkbox" <c:if test="${map.insurance_matterList[16].policyholderResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[16].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:15px;"><input type="checkbox" <c:if test="${map.insurance_matterList[17].policyholderResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[17].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[18].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[18].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[19].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[19].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;margin-top:15px;"><input type="checkbox" <c:if test="${map.insurance_matterList[20].policyholderResult=='true'}">checked</c:if>>是<input
                                        type="checkbox"
                                        style="margin-left: 10px;" <c:if test="${map.insurance_matterList[20].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[21].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[21].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[22].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox"
                                                                                            style="margin-left: 10px;" <c:if test="${map.insurance_matterList[22].policyholderResult=='false'}">checked</c:if>>否
                                </div>
                                <div style="display: block;"><input type="checkbox" <c:if test="${map.insurance_matterList[23].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox"
                        ...
                        <div class="table-line" style="height: 40px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height: 40px;"><input type="checkbox" <c:if test="${map.insurance_matterList[24].insuredResult=='true'}">checked</c:if>>是<input
                            ...
                            <div class="div-table-2" style="width: 83px;height: 40px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[24].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[24].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 197px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height: 197px;"><input type="checkbox" <c:if test="${map.insurance_matterList[25].insuredResult=='true'}">checked</c:if>>是<input
                            ...
                            <div class="div-table-2" style="width: 83px;height: 197px;border-right:#000000 1px solid;">
                                <input type="checkbox" <c:if test="${map.insurance_matterList[25].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[25].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                        <div class="table-line" style="height: 28px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height: 28px;"><input type="checkbox" <c:if test="${map.insurance_matterList[26].insuredResult=='true'}">checked</c:if>>是<input
                        ...
                        <div class="table-line" style="height: 28px;">
                            ...
                            <div class="div-table-2" style="width: 83px;height: 28px;"><input type="checkbox" <c:if test="${map.insurance_matterList[27].insuredResult=='true'}">checked</c:if>>是<input
                            ...
                            <div class="div-table-2" style="width: 83px;height: 28px;border-right:#000000 1px solid;">
                                <input
                                        type="checkbox" <c:if test="${map.insurance_matterList[27].policyholderResult=='true'}">checked</c:if>>是<input type="checkbox" style="margin-left: 10px;" <c:if test="${map.insurance_matterList[27].policyholderResult=='false'}">checked</c:if>>否
                            </div>
                        </div>
                    </div>
