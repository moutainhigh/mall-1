            ...
            <div class="th-tab prints">
                            ...
                            <div class="al-line">
                                <div class="al-font">
                                    <div class="al-row-2" style="margin-left: 15px;">
                                        <div style="margin-top: -5px;margin-left: 105px;position: absolute;">&nbsp;</div>
                                        <div style="margin-top: -5px;margin-left: 190px;position: absolute;">&nbsp;</div>
                                        <div style="margin-top: -5px;margin-left: 275px;position: absolute;">&nbsp;</div>
                                        <div style="margin-top: -5px;margin-left: 400px;position: absolute;">&nbsp;</div>
                                    </div>
                            ...
                            <div class="al-line">
                                <div class="al-font">
                                    <div class="al-row-2" style="margin-left: 433px;">
                                        <div style="margin-left: 110px;position: absolute;margin-top: -15px;">&nbsp;</div>
                                        <div style="margin-left: 152px;position: absolute;margin-top: -15px;">&nbsp;</div>
                                    </div>
                            ...
                            <div class="al-line">
                                <div class="al-font">
                                    <div class="al-row-2" style="margin-left: 237px;">
                                        <div style="margin-left: 105px;position: absolute;margin-top: -3px;">&nbsp;</div>
                                        <div style="margin-left: 145px;position: absolute;margin-top: -3px;">&nbsp;</div>
                                    </div>
                                    <div class="al-font" style="margin-left: 450px;position: absolute;margin-top: -6px;">
                                        <div class="al-row-sex">&nbsp;</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="al-tab">
                            <div class="al-line">
                                <div class="al-font">
                                    ...
                                    <div class="al-font" style="margin-left: 510px;position: absolute;margin-top: -3px;">
                                        <div class="al-row-sex">&nbsp;</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="al-line">
                                <div class="al-font">
                                    <div class="al-row-2" style="margin-left: 100px;">
                                        ...
                                        <div style="margin-left: 138px;position: absolute;margin-top: -8px;">&nbsp;</div>
                                    </div>
                                    <div class="al-font" style="margin-left: 310px;position: absolute;margin-top: -11px;">
                                        <div class="al-row-sex">&nbsp;</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="div-tab">
                    ...
                    <div class="table-line" style="height: 53px;">
                        ...
                        <div class="div-table-2" style="width: 83px;height: 53px;border-right:#000000 1px solid;"><input
                    ...
                    <div class="table-line" style="height: 25px;">
                        ...
                        <div class="div-table-2" style="width: 83px;height: 25px;border-right:#000000 1px solid;"><input
                                type="checkbox">是<input type="checkbox" style="margin-left: 10px;">否
                        </div>
                    </div>
                    <div class="table-line" style="height: 60px;">
                        ...
                        <div class="div-table-2" style="width: 83px;height: 60px;border-right:#000000 1px solid;"><input
                                type="checkbox">是<input type="checkbox" style="margin-left: 10px;">否
                        </div>
                    </div>
                    <div class="table-line" style="height: 30px;">
                        <div class="div-table-2"
                            ...
                            <div style="display: inline-block;width: 600px;">是否曾经或正在使用镇静安眠剂、可成瘾药物、麻醉剂或接受戒毒、戒酒治疗？</div>
                        </div>
                        <div class="div-table-2" style="width: 83px;height: 30px;"><input type="checkbox">是<input
                                type="checkbox" style="margin-left: 10px;">否
                        </div>
                        <div class="div-table-2" style="width: 83px;height: 30px;border-right:#000000 1px solid;"><input
                                type="checkbox">是<input type="checkbox" style="margin-left: 10px;">否
                        </div>
                    </div>
                    <div class="table-line" style="height: 30px;">
                        <div class="div-table-2"
                            ...
                            <div style="display: inline-block;width: 600px;">最近六个月内是否有医生建议您服药、住院、接受诊疗、手术或其他医疗方案？</div>
                        </div>
                        <div class="div-table-2" style="width: 83px;height: 30px;"><input type="checkbox">是<input
                                type="checkbox" style="margin-left: 10px;">否
                        </div>
                ...
                <div class="div-tab" style="margin-top: 60px;">
                    <div class="table-line" style="height: 58px;">
                        ...
                        <div class="div-table-2" style="width: 83px;height:58px;border-right:#000000 1px solid;"><input
                                type="checkbox">是<input type="checkbox" style="margin-left: 10px;">否
                        </div>
                    </div>
                    <div class="table-line" style="height: 465px;">
                        ...
                        <div class="div-table-2" style="width: 83px;height: 465px;vertical-align: top">
                            <div style="display: block;margin-top:25px;"><input type="checkbox">是<input type="checkbox"
                                                                                                        style="margin-left: 10px;">否
                            </div>
                            <div style="display: block;margin-top:125px;"><input type="checkbox">是<input type="checkbox"
                                                                                                         style="margin-left: 10px;">否
                            </div>
                            <div style="display: block;margin-top:0;"><input type="checkbox">是<input type="checkbox"
                                                                                                     style="margin-left: 10px;">否
                            </div>
                            <div style="display: block;margin-top:15px;"><input type="checkbox">是<input type="checkbox"
                                                                                                        style="margin-left: 10px;">否
                            </div>
                    ...
                    <div class="table-line" style="height: 40px;">
                        ...
                        <div class="div-table-2" style="width: 83px;height: 40px;border-right:#000000 1px solid;"><input
                                type="checkbox">是<input type="checkbox" style="margin-left: 10px;">否
                        </div>
                    </div>
                    ...
                    <div class="table-line" style="height: 28px;">
                        ...
                        <div class="div-table-2" style="width: 83px;height: 28px;border-right:#000000 1px solid;"><input
                                type="checkbox">是<input type="checkbox" style="margin-left: 10px;">否
                        </div>
                    </div>
                </div>
