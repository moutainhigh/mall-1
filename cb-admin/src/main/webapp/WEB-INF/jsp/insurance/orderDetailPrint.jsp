                    ...
                    <div style="height: 1465px;">
                        ...
                        <div class="div-tab">
                            ...
                            <div class="div-line">
                                <div class="div-line-con div-row-5">
                                    ...
                                    <div>
                                        ...
                                        <input class="i-cb" style="margin-left: 15px"
                                ...
                                <div class="div-line-con div-row-3">
                                    ...
                                    <input class="b-input" type="text" style="margin-left: 5px;"
                            ...
                            <div class="div-line">
                                ...
                                <div class="div-line-con div-row-3">
                                    <div class="title">A 11.固定电话（<input class="b-input" type="text"
                        ...
                        <div class="div-tab">
                            <div class="div-line">
                                <div class="div-line-con" style="padding: 7px 5px 7px 10px;">
                                    A 41. 信函寄往
                                    <div><input class="a-input" type="text" id="policyholderProvinces"
                                                style="width: 60px;"/>省
                                    </div>
                                    <div><input class="a-input" type="text" id="policyholderCitys"
                                                style="width: 80px;"/>市
                                    </div>
                                    <div><input class="a-input" type="text" id="policyholderDistricts"
                    ...
                    <div style="height: 1465px;">
                            ...
                            <div class="div-line">
                                <div class="div-line-con" style="width: 480px;padding: 10px 5px 10px 10px;">
                                    <div class="div-block">B1.交费周期：<input type="checkbox"/>趸交<input
                                            ...
                                            style="margin-left: 25px;" type="checkbox"/>半年交<input
                        ...
                        <div class="div-tab">
                            ...
                            <div class="table-line" style="height: 53px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height: 53px;"><input type="checkbox"
                            ...
                            <div class="table-line" style="height: 25px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height: 25px;"><input type="checkbox"
                            ...
                            <div class="table-line" style="height: 60px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height: 60px;"><input type="checkbox"
                            ...
                            <div class="table-line" style="height: 30px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height: 30px;"><input type="checkbox"
                            ...
                            <div class="table-line" style="height: 160px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height: 160px;"><input type="checkbox"
                    ...
                    <div style="height: 1465px;">
                        <div class="div-tab">
                            <div class="table-line" style="height: 58px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height:58px;"><input type="checkbox"
                            ...
                            <div class="table-line" style="height: 465px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height: 465px;vertical-align: top">
                                    <div style="display: block;margin-top:25px;"><input type="checkbox"
                                    ...
                                    <div style="display: block;margin-top:125px;"><input type="checkbox"
                                    ...
                                    <div style="display: block;margin-top:0;"><input type="checkbox"
                                    ...
                                    <div style="display: block;margin-top:15px;"><input type="checkbox"
                                    ...
                                    <div style="display: block;"><input type="checkbox"
                            ...
                            <div class="table-line" style="height: 40px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height: 40px;"><input type="checkbox"
                            ...
                            <div class="table-line" style="height: 197px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height: 197px;"><input type="checkbox"
                            ...
                            <div class="table-line" style="height: 28px;">
                                ...
                                <div class="div-table-2" style="width: 83px;height: 28px;"><input type="checkbox"
                        ...
                        <div class="hidden-prints">
                            ...
                            <div class="div-tab" style="margin-top: 5px;">
                                ...
                                <div class="div-line" style="border-bottom: solid 0px;">
                                    <div class="div-line-con-four">
                                        <div class="title"><span
                                                class="body-font"> &nbsp;2.&nbsp;&nbsp;&nbsp;投保经过：</span></div>
                                        <div>
                                            ...
                                            <input class="i-cb" type="checkbox"/> <span
                                ...
                                <div class="div-line">
                                    <div class="div-line-con-four div-win-2">
                                        <div class="title" style="padding-left: 60px;"><span
                                                class="b-body-font">附件名称</span></div>
                                    </div>
                                    <div class="div-line-con-four div-win-2">
                                        <div class="title " style="padding-left: 60px;"><span
                                                class="b-body-font">种类</span></div>
                                    </div>
                                    <div class="div-line-con-four div-win-2">
                                        <div class="title " style="padding-left: 60px;"><span
                                                class="b-body-font">页数</span></div>
                                    </div>
                                    <div class="div-line-con-four div-win-2">
                                        <div class="title" style="padding-left: 60px;"><span
