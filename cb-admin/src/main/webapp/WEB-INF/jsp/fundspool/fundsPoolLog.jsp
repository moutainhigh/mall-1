...
<head>
    ...
    <script type="text/javascript">
        ...
        function detailItem(){
            ...
            if (dataItem) {
                window.location.href = "fundsPoolLogDetail.do?id=" + dataItem.poolLogId;
            }
        }
         ...
         * @returns {string}
         */
        function formatFundsPoolLogType(type) {
            type = type + "";
            switch (type) {
                case "1":
                    return "累计";
    ...
    <header id="header-main">
        ...
        <div class="header-main-bottom">
            <div class="pull-left">
                <ul class="breadcrumb">
                    <li><a href="#">首页</a></li>
                    <li><a href="#">资金池明细管理</a></li>
                    <li class="active"><a href="#">资金池明细列表</a></li>
                </ul>
                <!-- End .breadcrumb -->
            </div>
            <div class="pull-right">
            ...
            <div class="inner-padding">
                <div class="toolbar responsive-helper">
                    <form style="width: 100%">
                        <div class="pull-left">
                            ...
                            <div class="toolbar-field">
                                <select data-filter="fundsPool.poolId" data-operator="eq" class="form-control  grid-filter">
                                    <option value="">全部</option>
                                    <c:forEach items="${fundsPoolList}" var="obj">
                                        <option value="${obj.poolId}">${obj.poolName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                ...
                <div class="table-wrapper">
                    <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="450" resizable="true">
                        ...
                        <kendo:grid-columns >
                            <kendo:grid-column field="poolLogId" width="350px" hidden="true"/>
                            <kendo:grid-column title="资金池名称" filterable="false" template="<a href='fundsPoolLogDetail.do?id=#= poolLogId#'>#= poolName#</a>" width="100px"/>
                            <kendo:grid-column title="金额" filterable="false" field="funds" width="100px"/>
                            <kendo:grid-column title="累计为订单ID/报帐为报帐ID" filterable="false" field="transactionId" width="120px"/>
                            <kendo:grid-column title="订单详情ID/报账详情ID" filterable="false" field="itemId" width="100px"/>
                            <kendo:grid-column title="操作金额" filterable="false" field="amount" width="100px"/>
                            <kendo:grid-column title="操作时间" filterable="false" field="createTime" format="{0:yyyy-MM-dd HH:mm:ss}"  width="100px"/>
                            <kendo:grid-column title="类型" filterable="false" field="type" template="#=formatFundsPoolLogType(type)#"  width="20px"/>
                        ...
                        <kendo:dataSource serverPaging="true" serverFiltering="true" serverSorting="true">
                            ...
                            <kendo:dataSource-transport>
                                <kendo:dataSource-transport-read url="pageFundsPoolLog.do" type="POST" contentType="application/json"/>
