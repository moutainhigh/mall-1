  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $.citySelector.init({
        ...
        city: "city",
        district:"district",
        preProvince: "${customer.province}",
        preCity: "${customer.city}",
        preDistrict:"${customer.district}"
      });
...
<div id="main" class="clearfix">
  ...
  <div id="content" class="clearfix">
    ...
    <div class="window">
      ...
      <!-- End .actionbar-->
      <div class="inner-padding">
        <form:form id="validateSubmitForm" cssClass="form-horizontal" data-asf-expireafter="1" data-asf-time="10" action="editCustomer.do" method="post" commandName="customer" >
          ...
          <fieldset>
            ...
            <div class="row">
              <div class="inline-labels">
                ...
                <div class="col-sm-3">
                  <form:input path="accountName" cssClass="form-control validate[required]" maxlength="64" />
                </div>
            ...
            <div class="row">
              <div class="inline-labels">
                ...
                <div class="col-sm-3">
                  <kendo:datePicker id="birthday" name="birthday" value="${customer.birthday}" format="yyyy-MM-dd" parseFormats="['yyyy-MM-dd']" culture="zh-CN"></kendo:datePicker>
                </div>
                <div class="col-sm-1"></div>
                <div class="col-sm-2">
