...
<head>
  ...
  <script type="application/javascript">
    ...
    function detailItem(){
      ...
      if (dataItem) {
        window.location.href = "customerTradings.do?walletId=" + dataItem.walletId;
      }
    }
        ...
        <div class="inner-padding">
          ...
          <div class="toolbar responsive-helper">
            <header>
              ...
              <div class="pull-right">
                <div class="btn-group">
                  <a href="javascript:void(0);" onclick="detailItem()" class="btn btn-default"><i class="fa fa-info-circle"></i>&nbsp;交易记录</a>
          ...
          <div class="table-wrapper">
            <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="450" resizable="true">
              ...
              <kendo:grid-columns>
                <kendo:grid-column  field="walletId" width="350px" hidden="true"/>
                ...
                <kendo:grid-column filterable="false" title="性别" field="customer.sex" width="100px" template="#=formatSex(customer.sex)#"/>
                <kendo:grid-column title="手机号" field="customer.mobile" width="100px"/>
                <kendo:grid-column title="可用余额" field="availableBalance" width="100px"/>
                <kendo:grid-column title="预期收益金额" field="expectedReturnAmount" width="100px"/>
                <kendo:grid-column title="可贷额度" field="loanQuota" width="100px"/>
                <kendo:grid-column title="欠款金额" field="arrearsAmount" width="100px"/>
                <kendo:grid-column title="创建时间" field="createTime" width="150px" format="{0:yyyy-MM-dd HH:mm}" filterable="false"/>
                <kendo:grid-column title="更新时间" field="updateTime" width="150px" format="{0:yyyy-MM-dd HH:mm}" filterable="false"/>
              </kendo:grid-columns>
              <kendo:dataSource serverPaging="true" serverFiltering="true" serverSorting="true">
                ...
                <kendo:dataSource-transport>
                  <kendo:dataSource-transport-read url="pageCustomerWallets.do" type="POST" contentType="application/json"/>
