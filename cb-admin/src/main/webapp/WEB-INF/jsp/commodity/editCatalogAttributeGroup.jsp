...
<head>
    ...
    <script type="application/javascript">
        ...
        var idIndex = ${attributeGroup.catalogAttributes.size()==0}?0:${attributeGroup.catalogAttributes.size()};
...
<div id="main" class="clearfix">
    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <div class="inner-padding">
                <form:form id="validateSubmitForm" action="editCatalogAttributeGroup.do" method="post" commandName="attributeGroup">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    <form:input id="catalogName" readonly="true" cssClass="form-control validate[required]" path="catalog.catalogName" maxlength="64"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <table id="attributeTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach var="attribute" items="${attributeGroup.catalogAttributes}">
                                            ...
                                            <c:choose>
                                                <c:when test="${!empty attribute.imagePath}">
                                                    <td>
                                                        ...
                                                        <img id="img${attribute.attributeId}"    onclick="addImage(${attribute.attributeId})" src="${attribute.imagePath}" width="130px" height="120px" style="padding: 5px">
                                                        <input id="upload${attribute.attributeId}" onchange="onchangeImg('${attribute.attributeId}')" name="file" multiple="multiple" accept="image/*" type="file" style="display: none"/>
                                                    </td>
                                                </c:when>
                                                <c:otherwise>
