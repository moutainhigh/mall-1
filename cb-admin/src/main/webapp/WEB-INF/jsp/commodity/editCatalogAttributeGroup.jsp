...
<head>
    ...
    <script id="attributeImgTr" type="text/x-jquery-tmpl">
        <tr id='attribute{{= idIndex}}'>
            ...
            <td><input id="imagePath{{= idIndex}}" type='hidden' name='imagePath'/><a class='btn btn-default' href="javascript:chooseImage({{= idIndex}})">选择图片</a><img id="img{{= idIndex}}" src="" style="max-height:60px"/></td>
