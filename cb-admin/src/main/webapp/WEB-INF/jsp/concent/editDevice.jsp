  ...
  <div id="main" class="clearfix">
      ...
      <div class="header-main-bottom">
        <div class="pull-left">
          <ul class="breadcrumb">
            ...
            <li><a href="#">设备管理</a></li>
            <li><a href="#">厨电设备</a></li>
            <li class="active"><a href="#">编辑厨电设备</a></li>
          </ul>
          <!-- End .breadcrumb -->
        </div>
        <div class="pull-right">
    ...
    <div id="content" class="clearfix">
      ...
      <div class="window">
        ...
        <!-- End .actionbar-->
        <div class="inner-padding">
          <form:form id="validateSubmitForm" cssClass="form-horizontal" action="editDevice.do" method="post" commandName="device" >
            <form:hidden path="deviceId"/>
            <fieldset>
              <legend>编辑厨电设备</legend>
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <form:select class="form-control simpleselect" path="deviceType" readOnly="true">
                ...
                <div class="col-sm-3">
                  <form:input type="text" cssClass="form-control validate[required]" path="deviceCode"  maxlength="64" readOnly="true"/>
                </div>
              </div>
              <div class="spacer-10"></div>
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <form:select class="form-control simpleselect" path="concent.concentId" readOnly="true">
                ...
                <div class="col-sm-3">
                  <form:input path="factoryDate" readOnly="true"/>
                </div>
              </div>
              <div class="spacer-10"></div>
              <div class="row">
                ...
                <div class="col-sm-3">
                  <form:input type="text" cssClass="form-control validate[required,custom[integer]]" path="version" maxlength="4" readOnly="true"/>
                </div>
              </div>
