...
<head>
    ...
    <script type="text/javascript">
        ...
        function confirm(){
            ...
            if (dataItem) {
                window.location.href = "getLoanDetail.do?loanId=" + dataItem.loanId;
            }
        }
        ...
        <div class="header-main-bottom">
            <div class="pull-left">
                <ul class="breadcrumb">
                    <li><a href="#">首页</a></li>
                    <li><a href="#">财务管理</a></li>
                    <li class="active"><a href="#">借款管理</a></li>
                </ul>
            </div>
            <div class="pull-right">
                <p>Version 1.0.0</p>
                    ...
                    <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="450" resizable="true">
                        ...
                        <kendo:dataSource serverPaging="true" serverFiltering="true" serverSorting="true">
                            ...
                            <kendo:dataSource-transport>
                                <kendo:dataSource-transport-read url="pageLoanList.do?state=0" type="POST" contentType="application/json"/>
