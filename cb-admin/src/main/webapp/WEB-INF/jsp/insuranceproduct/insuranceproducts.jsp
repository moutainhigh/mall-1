...
<head>
    ...
    <script type="text/javascript">
        ...
        function detailItem(){
            ...
            if (dataItem) {
                window.location.href = "toEditProduct.do?prodId=" + dataItem.prodId;
            }
        }
            ...
            <div class="inner-padding">
                ...
                <div class="table-wrapper">
                    <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="450" resizable="true">
                        ...
                        <kendo:grid-columns>
                            <kendo:grid-column title="产品ID" field="prodId" template="<a href='toEditProduct.do?prodId=#= prodId#' style='color:blue'>#= prodId#</a>" width="100px"/>
                            <kendo:grid-column title="产品名称" field="prodName" width="50px"/>
                        ...
                        <kendo:dataSource serverPaging="true" serverFiltering="true" serverSorting="true">
                            ...
                            <kendo:dataSource-transport>
                                <kendo:dataSource-transport-read url="pageInsuranceProduct.do" type="POST" contentType="application/json"/>
