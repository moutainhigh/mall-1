...
<div id="main" class="clearfix">
    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <div class="inner-padding">
                <form:form id="validateSubmitForm" action="editSpecialSubject.do" data-asf-expireafter="1" data-asf-time="10" method="post" commandName="subject" cssClass="form-horizontal">
