...
<head>
    ...
    <script type="text/javascript">
        function editItem() {
            ...
            if (dataItem) {
                window.location.href = "toEditSpecialSubject.do?subjectId=" + dataItem.subjectId;
            }
        }
        ...
        function removeItem() {
            ...
            if (dataItem) {
                bootbox.confirm("确定删除吗？", function (result) {
                    if (result) {
                        $.get("removeSpecialSubjectById.do", {
        ...
        function enabledItem(enabled) {
            var dataItem = getSelectedGridItem("grid");
            if (dataItem) {
                $.get("enableSpecialSubjectById.do", {
                    subjectId: dataItem.subjectId,
                    enabled: enabled,
                    rad: Math.random()
                }, function (data) {
                            ...
                            <ul>
                                <c:forEach var="programa" items="${programas}">
                                    <c:if test="${programa.articleChannel.channelId==channel.channelId}">
                                        <li><i class="fa fa-file-text"></i><a href="javascript:filterPrograma(${programa.programaId})">${programa.programaName}</a></li>
                                    </c:if>
                                </c:forEach>
                            </ul>
                        </li>
        ...
        <div class="header-main-bottom">
            <div class="pull-left">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">内容管理</a></li>
                    <li class="active"><a href="articles.do">专题管理</a></li>
                </ul>
            </div>
            <div class="pull-right">
                <p>Version 1.0.0</p>
            ...
            <div class="inner-padding">
                <div class="toolbar responsive-helper">
                    <form>
                        <div class="pull-left">
                            ...
                            <div class="toolbar-field">
                                <input type="text" data-filter="subjectName" data-operator="contains" class="form-control grid-filter" placeholder="请输入专题名称"/>
                            </div>
                ...
                <div class="toolbar responsive-helper">
                    <header>
                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                <a href="toAddSpecialSubject.do" class="btn btn-default"><i class="fa fa-plus-circle"></i>&nbsp;新增</a>
                ...
                <div class="table-wrapper">
                    <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="500" resizable="true">
                        ...
                        <kendo:grid-columns>
                            <kendo:grid-column title="专题名称" field="subjectName" width="80"/>
                            <kendo:grid-column title="栏目" field="programa.programaName" width="80"/>
                            <kendo:grid-column title="频道" field="programa.articleChannel.channelName" width="130" filterable="false"/>
                            <kendo:grid-column title="简短标题" field="shortName" width="80"/>
                            <kendo:grid-column title="文章数量" field="articleAmount" width="80"/>
                            <kendo:grid-column title="发布日期" field="publishDate" width="80" format="{0:yyyy-MM-dd}"/>
                            <kendo:grid-column title="排序时间" field="orderTime" width="120" format="{0:yyyy-MM-dd HH:mm}"/>
                        ...
                        <kendo:dataSource serverPaging="true" serverFiltering="true" serverSorting="true">
                            ...
                            <kendo:dataSource-transport>
                                <kendo:dataSource-transport-read url="pageSpecialSubjects.do" type="POST" contentType="application/json"/>
