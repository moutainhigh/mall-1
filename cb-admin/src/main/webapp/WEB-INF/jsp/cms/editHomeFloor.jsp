...
<div id="main" class="clearfix">
        ...
        <div class="header-main-bottom">
            <div class="pull-left">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">内容管理</a></li>
                    <li><a href="#">首页管理</a></li>
                    <li><a href="#">修改首页楼层</a></li>
                    <li class="active">修改首页楼层</li>
                </ul>
            </div>
            <div class="pull-right">
                <p>Version 1.0.0</p>
    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <div class="inner-padding">
                <form:form id="validateSubmitForm" action="editHomeFloor.do" cssClass="form-horizontal" method="post" commandName="homeFloor">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <img id="previewIconPath" src="../images/${homeFloor.iconPath}" style="max-width:60px ">
                            </div>
                        </div>
                        <div class="spacer-10"></div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <img id="previewImagePath" src="../images/${homeFloor.imagePath}" style="max-width:600px ">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <table id="commodityTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach var="fc" items="${homeFloor.floorCommodities}">
                                        <tr id='commodity${homeFloor.floorId}${fc.commodity.commodityId}'>
                                            <td><input type='hidden' name='commodityId' class='form-control' value='${fc.commodity.commodityId}'/>${fc.commodity.commodityName}</td>
                                            <td><input type='text' name='commodityOrder' class='form-control' value='${fc.sortOrder}'/></td>
                                            <td class='text-center'><a type='button' title='删除' class='btn btn-default' href='javascript:removeCommodity(${homeFloor.floorId}${fc.commodity.commodityId})'><i class='fa fa-minus-circle'></i></a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <table id="categoryTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach var="fc" items="${homeFloor.floorCategories}">
                                        <tr id='category${homeFloor.floorId}${fc.category.categoryId}'>
                                            <td><input type='hidden' name='categoryId' class='form-control' value='${fc.category.categoryId}'/>${fc.category.categoryName}</td>
                                            <td><input type='text' name='categoryOrder' class='form-control' value='${fc.sortOrder}'/></td>
                                            <td class='text-center'><a type='button' title='删除' class='btn btn-default' href='javascript:removeCategory(${homeFloor.floorId}${fc.category.categoryId})'><i class='fa fa-minus-circle'></i></a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
