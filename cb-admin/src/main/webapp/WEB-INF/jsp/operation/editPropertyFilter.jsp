...
<div id="main" class="clearfix">
    ...
    <div id="content" class="clearfix">
        ...
        <div class="window">
            ...
            <div class="inner-padding">
                <form:form id="validateSubmitForm" data-asf-expireafter="1" data-asf-time="10" action="editPropertyFilter.do" method="post" commandName="filter">
                                ...
                                <table id="filterTable" class="table table-bordered table-striped">
                                    ...
                                    <c:forEach var="item" items="${filter.filterItems}">
                                        <tr id='filterItem${item.itemId}'>
                                            <td><input type="hidden" name="itemId" value="${item.itemId}"/> <input type='text' name='itemName' value="${item.itemName}"  class='form-control validate[required]'/></td>
