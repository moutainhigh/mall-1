...
<head>
  ...
  <script type="application/javascript">
    function returnComplaints(){
      window.location.href = "complaints.do";
    }
  </script>
...
<div id="main" class="clearfix">
  ...
  <div id="content" class="clearfix">
    ...
    <div class="window">
      ...
      <!-- End .actionbar-->
      <div class="inner-padding">
        <form id="autosavethisform" data-asf-expireafter="1" data-asf-time="10" action="addComplaint.do" method="post" enctype="multipart/form-data" commandName="complaint">
          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" required="true" name="title" aria-required="true">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" required="true" name="content" aria-required="true">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                ...
                <button class="btn btn-default pull-right" type="reset" onclick="returnComplaints()">返回</button>
