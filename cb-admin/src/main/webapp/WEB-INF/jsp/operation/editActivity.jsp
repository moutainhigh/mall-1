  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $("#startTime").kendoDateTimePicker({
        ...
        value:kendo.toString("${activity.startTime}", "yyyy-MM-dd HH:mm:ss"),
        min: new Date(),
        culture:"zh-CN",
      ...
      $("#endTime").kendoDateTimePicker({
        format: "yyyy-MM-dd HH:mm:ss",
        value:kendo.toString("${activity.endTime}", "yyyy-MM-dd HH:mm:ss"),
...
<div id="main" class="clearfix">
  ...
  <div id="content" class="clearfix">
    ...
    <div class="window">
      ...
      <!-- End .actionbar-->
      <div class="inner-padding">
        <form:form id="validateSubmitForm" action="editActivity.do" cssClass="form-horizontal" method="post" commandName="activity">
          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <img id="previewImagePath" src="../images/${activity.picPath}_870_280.jpg" style="max-width:600px ">
              </div>
            </div>
