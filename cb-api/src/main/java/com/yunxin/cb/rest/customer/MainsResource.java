...
@RestController
@CrossOrigin
@RequestMapping(value = "/{version}/noAuth")
public class MainsResource extends BaseResource {

    private static Logger logger = LoggerFactory.getLogger(MainsResource.class);
...
//            redisService.getKey(mobile);
            ...
            customer.setPassword(RSAUtils.decryptData(pwd, privateKey));
...
//    }
    ...
    public ResponseResult updatePwd(@PathVariable String mobile, @RequestParam String code, @RequestParam String newPwd) {
        ...
        newPwd=RSAUtils.decryptData(newPwd, privateKey);
    ...
    public ResponseResult resetPwd(@RequestParam String mobile, @RequestParam String code, @RequestParam String resetNewPwd) {
        ...
        resetNewPwd=RSAUtils.decryptData(resetNewPwd, privateKey);
