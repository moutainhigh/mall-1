...
public class GoodsChange implements Serializable {
    ...
    public int getGoodsChangeId() {
        return goodsChangeId;
    }

    public void setGoodsChangeId(int goodsChangeId) {
    ...
    public void setChangeCount(int goodsChageCounts) {
        this.changeCount = goodsChageCounts;
    }
