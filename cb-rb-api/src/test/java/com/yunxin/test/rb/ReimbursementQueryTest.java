...
import com.yunxin.cb.rest.rb.DemoResource;
...
public class ReimbursementQueryTest {
    ...
    public void setUp() throws Exception {
        mvc = MockMvcBuilders.standaloneSetup(new DemoResource()).build();
//        mvc = MockMvcBuilders.webAppContextSetup(this.context).build();
    ...
    public void getReimbursementTest() throws Exception {
        ...
        //mock进行模拟
        MvcResult mvcResult = mvc.perform(MockMvcRequestBuilders.get("/v1/rb/demo/deliveryAddress/list")
