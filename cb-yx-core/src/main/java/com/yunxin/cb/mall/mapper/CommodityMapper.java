...
public interface CommodityMapper {
	...
	@Results({
			...
			@Result(column="BRAND_ID", property="brand", jdbcType=JdbcType.INTEGER,
					one = @One(select = "com.yunxin.cb.mall.dao.BrandMapper.selectByPrimaryKey")),
			@Result(column="SECTION_ID", property="priceSection", jdbcType=JdbcType.INTEGER,
					one = @One(select = "com.yunxin.cb.mall.dao.PriceSectionMapper.selectByPrimaryKey")),
			@Result(column="SELLER_ID", property="seller", jdbcType=JdbcType.INTEGER,
					one = @One(select = "com.yunxin.cb.mall.dao.SellerMapper.selectByPrimaryKey")),
			@Result(column = "COMMODITY_ID",property = "commoditySpecs",
					many = @Many(select = "com.yunxin.cb.mall.dao.CommoditySpecMapper.selectAllByCommodityId"))
	})
