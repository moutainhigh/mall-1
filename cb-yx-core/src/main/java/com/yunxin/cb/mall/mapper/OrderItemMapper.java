...
public interface OrderItemMapper {
    String columns = "ITEM_ID, ORDER_ITEM_PRICE," +
            "        PRODUCT_IMG, PRODUCT_NUM," +
            "        SALE_PRICE, ORDER_ID," +
            "        PRODUCT_ID, COST_PRICE," +
            "        PRODUCT_NAME, PRODUCT_NO," +
            "        MARKET_PRICE, EVALUATE," +
            "        VOLUME, WEIGHT, BUYER_MESSAGE," +
            "        CREATE_TIME";
    /**
     * This method was generated by MyBatis Generator.
     * This method corresponds to the database table yx_order_item
     *
     * @mbg.generated Wed Jul 18 10:37:44 CST 2018
     */
    @Delete({
        "delete from yx_order_item",
     ...
     */
    @Insert({
        "insert into yx_order_item (",
            columns,
        ")",
            "values (#{itemId,jdbcType=INTEGER}, #{orderItemPrice,jdbcType=REAL}, ",
            "#{productImg,jdbcType=VARCHAR}, #{productNum,jdbcType=INTEGER}, ",
            "#{salePrice,jdbcType=REAL}, #{orderId,jdbcType=INTEGER}, ",
            "#{productId,jdbcType=INTEGER}, #{costPrice,jdbcType=REAL}, ",
            "#{productName,jdbcType=VARCHAR}, #{productNo,jdbcType=VARCHAR}, ",
            "#{marketPrice,jdbcType=REAL}, #{evaluate,jdbcType=BIT}, ",
            "#{volume,jdbcType=REAL}, #{weight,jdbcType=REAL}, #{buyerMessage,jdbcType=VARCHAR}, ",
