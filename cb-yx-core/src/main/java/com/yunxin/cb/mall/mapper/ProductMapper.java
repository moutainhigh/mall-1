...
public interface ProductMapper {
    ...
    @Results({
            ...
            @Result(column = "PRODUCT_ID",property = "productAttributes",
                    many = @Many(select = "com.yunxin.cb.mall.dao.ProductAttributeMapper.selectAllByProductId"))
    })
    ...
    Product selectProductById(@Param("productId") Integer productId,@Param("state") Integer state,@Param("publish") Integer publish);
    ...
    @Results({
            ...
            @Result(column="COMMODITY_ID", property="commodity", javaType=Commodity.class,
                    one=@One(select="com.yunxin.cb.mall.dao.CommodityMapper.selectByPrimaryKey"))
    })
